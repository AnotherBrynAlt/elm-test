...
{
	if (region.bo.bF === region.a6.bF)
	{
		return 'on line ' + region.bo.bF;
	}
	return 'on lines ' + region.bo.bF + ' through ' + region.a6.bF;
}
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'title',
					$elm$json$Json$Encode$string($.bL))
				]));
	});
...
var $jfmengels$elm_review_common$NoDeprecated$defaults = function () {
	...
	return {
		aN: _List_Nil,
		ar: documentationPredicate,
		aA: F2(
			function (_v0, name) {
				return containsDeprecated(name);
			}),
		bs: _List_Nil,
		b6: function (moduleName) {
			return containsDeprecated(
				A2($elm$core$String$join, '.', moduleName));
		},
		b8: containsDeprecated,
		b9: containsDeprecated
	};
}();
...
var $jfmengels$elm_review$Review$Rule$configurationError = F2(
	function (name, configurationError_) {
		return {
			ad: $elm$core$Maybe$Just(configurationError_),
			ah: $jfmengels$elm_review$Review$Exceptions$init,
			a$: name,
			H: {al: false, bn: false},
			ao: F3(
...
var $jfmengels$elm_review_common$NoDeprecated$createElementPredicate = function (_v0) {
	...
	if ($elm$core$List$isEmpty(configuration.bs)) {
		return $elm$core$Result$Ok(
			F2(
				function (moduleName, name) {
					return A2(configuration.aA, moduleName, name);
				}));
	} else {
		var _v1 = $jfmengels$elm_review_common$NoDeprecated$parseNames(configuration.bs);
		if (!_v1.$) {
			var exceptionsForElements = _v1.a;
			return $elm$core$Result$Ok(
				F2(
					function (moduleName, name) {
						return A2(configuration.aA, moduleName, name) && (!A2(
							$elm$core$Set$member,
...
var $jfmengels$elm_review$Review$Rule$globalError = function (_v0) {
	...
	return $jfmengels$elm_review$Review$Rule$SpecifiedError(
		{bO: details, cs: 'GLOBAL ERROR', cu: $elm$core$Maybe$Nothing, aw: message, cH: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, cK: '', dJ: 4});
};
...
var $jfmengels$elm_review_common$NoDeprecated$registerDeprecatedThings = F3(
	function (_v0, module_, acc) {
		var configuration = _v0;
		var moduleName = A2($elm$core$String$split, '.', module_.a$);
		if (configuration.ar(module_.a4)) {
			return {
				t: acc.t,
				u: A2(
					$elm$core$List$cons,
			...
			var commentIndicatesDeprecation = function (_v4) {
				var comment = _v4.a4;
				return configuration.ar(comment);
			};
			var deprecatedAliases = A2($elm$core$List$filter, commentIndicatesDeprecation, module_.cT);
			var deprecatedUnions = A2($elm$core$List$filter, commentIndicatesDeprecation, module_.dP);
			var newValues = $elm$core$List$concat(
				_List_fromArray(
					[
						...
						$elm$core$List$map,
						function (value) {
							return _Utils_Tuple2(moduleName, value.a$);
						},
						A2($elm$core$List$filter, commentIndicatesDeprecation, module_.dQ)),
						A2(
						$elm$core$List$map,
						function (_v1) {
							var name = _v1.a$;
				...
				return $jfmengels$elm_review$Review$Rule$globalError(
					{
						...
						aw: 'Could not find package `' + (name + '`')
					});
			},
			A2(
		...
		var newContext = A3(
			...
			F3(
				function (packageName, dependency, acc) {
					...
					return A2($elm$core$List$member, packageName, configuration.aN) ? _Utils_update(
						acc,
						{
							u: _Utils_ap(
								A2(
...
var $jfmengels$elm_review$Review$Rule$moduleNameFromMetadata = function (_v0) {
	var metadata = _v0;
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(metadata.cC);
};
		...
		function (data) {
			return A2(
				...
				$jfmengels$elm_review$Review$Rule$createMetadata(
					{
						cA: data.cA,
						cC: $jfmengels$elm_review$Review$Rule$moduleNameNode(data.dW.el)
					}));
		},
		requestedData);
};
	...
	$jfmengels$elm_review$Review$Rule$initContextCreator(
		F2(
			function (metadata, moduleContext) {
				return {
					t: moduleContext.bG,
					u: moduleContext.be ? _List_fromArray(
						[
							_Utils_Tuple2(
...
var $jfmengels$elm_review$Review$Rule$functionToExpression = function (_function) {
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d5).bV;
};
	...
	switch (_v0.$) {
		...
		case 4:
			...
			return _List_fromArray(
				[cond, then_, else_]);
		case 15:
			var expression = _v0.a.bV;
			var declarations = _v0.a.c0;
			return _Utils_ap(
				A2(
					$elm$core$List$map,
	...
	function (expressionRelatedVisitors, caseBlockWithRange, caseBranch, errorsAndContext) {
		...
		return A4(
			...
			A3(
				...
				caseExpression,
				A4($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors2, expressionRelatedVisitors.U, caseBlockWithRange, caseBranch, errorsAndContext)));
	});
	...
	function (expressionRelatedVisitors, letBlockWithRange, letDeclarationWithRange, errorsAndContext) {
		...
		return A4(
			...
			A3(
				...
				expressionRelatedVisitors,
				expressionNode,
				A4($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors2, expressionRelatedVisitors._, letBlockWithRange, letDeclarationWithRange, errorsAndContext)));
	});
			...
			if (!nodesToVisit.b) {
				...
				switch (_v1.$) {
					...
					case 4:
						...
						continue expressionChildrenTCO;
					case 15:
						var expression = _v1.a.bV;
						var declarations = _v1.a.c0;
						var $temp$nodesToVisit = A2(
							$elm$core$List$append,
							A2(
								$elm$core$List$map,
...
var $jfmengels$elm_review$Review$Rule$createExpressionVisitor = function (schema) {
	if ((!$elm$core$List$isEmpty(schema._)) || ((!$elm$core$List$isEmpty(schema.aa)) || ((!$elm$core$List$isEmpty(schema.U)) || (!$elm$core$List$isEmpty(schema.V))))) {
		...
		if (!$elm$core$List$isEmpty(schema.C)) {
			var exitVisitors = schema.C;
...
var $jfmengels$elm_review$Review$Rule$shouldVisitDeclarations = function (schema) {
	return (!$elm$core$List$isEmpty(schema.W)) || (!$elm$core$List$isEmpty(schema.X));
};
	...
	function (declarationVisitorsOnEnter, declarationVisitorsOnExit, expressionVisitor, node, errorsAndContext) {
		...
		if (!_v0.$) {
			...
			return A3(
				...
				A2(
					expressionVisitor,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d5).bV,
					A3($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors, declarationVisitorsOnEnter, node, errorsAndContext)));
		} else {
				...
				function (nodes, initialErrorsAndContext) {
					return A3(
						...
						A3(
							...
							$elm$core$List$reverse(schema.W),
							schema.X,
							expressionVisitor),
						initialErrorsAndContext,
						nodes);
...
var $jfmengels$elm_review$Review$Rule$fromModuleRuleSchemaToRunnableModuleVisitor = function (_v0) {
	...
	return {
		...
		af: $elm$core$List$reverse(schema.af),
		m: $elm$core$List$reverse(schema.m),
		ai: $elm$core$List$reverse(schema.ai),
		aj: $elm$core$List$reverse(schema.aj),
		ak: $elm$core$List$reverse(schema.ak)
	};
};
var $jfmengels$elm_review$Review$Rule$mergeModuleVisitorsHelp = F3(
	function (initialProjectContext, moduleContextCreator, visitors) {
				...
				$stil4m$elm_syntax$Elm$Syntax$Module$NormalModule(
					{
						...
						b5: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, _List_Nil)
					}))
		};
		var dummyAvailableData = {
			dW: dummyAst,
			bW: $elm$core$Basics$always('dummy'),
			cs: 'dummy file path',
			cA: true,
			b4: 'dummy',
			al: $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty(_List_Nil)
		};
		...
		var emptyModuleVisitor = {
			...
			m: _List_Nil,
			ai: _List_Nil,
			bD: $elm$core$Maybe$Just(initialModuleContext),
			_: _List_Nil,
			aa: _List_Nil,
			I: $jfmengels$elm_review$Review$Rule$initContextCreator(
...
var $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor = function (_v0) {
	...
	return {
		...
		A: $elm$core$List$reverse(schema.A),
		m: $elm$core$List$reverse(schema.m),
		aF: schema.aF,
		cD: A3($jfmengels$elm_review$Review$Rule$mergeModuleVisitors, schema.aF, schema.I, schema.bg),
		D: $elm$core$List$reverse(schema.D),
		H: function () {
			var _v1 = schema.I;
			if (!_v1.$) {
				var _v2 = _v1.a;
				...
				return {al: false, bn: false};
			}
		}(),
		aK: function () {
			var _v3 = _Utils_Tuple2(schema.bM, schema.aP);
			if (!_v3.a) {
				var _v4 = _v3.a;
				return $jfmengels$elm_review$Review$Rule$TraverseAllModulesInParallel(schema.aP);
			} else {
				if (!_v3.b.$) {
					var _v5 = _v3.a;
					var folder = _v3.b.a;
	...
	function (_v0, getPath, items) {
		...
		return A2(
			...
			A2(
				$elm$core$Basics$composeR,
				getPath,
				A2($elm$core$Basics$composeR, $jfmengels$elm_review$Review$Exceptions$makePathOSAgnostic, allConditions)),
			items);
	});
...
var $stil4m$elm_syntax$Elm$Syntax$Module$moduleName = function (m) {
	switch (m.$) {
		case 0:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.b5);
		case 1:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.b5);
		default:
...
var $jfmengels$elm_review$Review$Rule$getModuleName = function (module_) {
	return $stil4m$elm_syntax$Elm$Syntax$Module$moduleName(
		$stil4m$elm_syntax$Elm$Syntax$Node$value(module_.dW.el));
};
...
var $jfmengels$elm_review$Vendor$IntDict$prefixMatches = F2(
	function (p, n) {
		return _Utils_eq(
			n & $jfmengels$elm_review$Vendor$IntDict$higherBitMask(p.a3),
			p.an);
	});
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.bE, key) ? $elm$core$Maybe$Just(l.cf) : $elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
...
var $jfmengels$elm_review$Review$Rule$computeModuleAndCacheResult = F6(
	function (traversalAndFolder, modules, graph, computeModule, _v0, _v1) {
		...
		var _v2 = A2($elm$core$Dict$get, node.cB, modules);
		if (_v2.$ === 1) {
						...
						function (key) {
							return A2(
								...
								function (nodeContext) {
									return A2($elm$core$Dict$get, nodeContext.dp.cB, modules);
								},
			...
			var compute = function (previousResult) {
				...
				return _Utils_Tuple2(
					A3($elm$core$Dict$insert, module_.eA, result, cache),
					(!_Utils_eq(
			...
			var _v3 = A2($elm$core$Dict$get, module_.eA, cache);
			if (_v3.$ === 1) {
				return compute($elm$core$Maybe$Nothing);
			} else {
				var cacheEntry = _v3.a;
				return (_Utils_eq(cacheEntry.eI, module_.eI) && A3($jfmengels$elm_review$Review$Rule$contextFromImportedModulesIsUnchanged, traversalAndFolder, importedModules, invalidatedModules)) ? _Utils_Tuple2(cache, invalidatedModules) : compute(
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					A2($elm$core$String$slice, 0, range.a6.ay - 1),
					A2(
						$elm$core$List$take,
						(range.a6.aJ - range.bo.aJ) + 1,
						A2($elm$core$List$drop, range.bo.aJ - 1, lines)))));
	});
...
var $jfmengels$elm_review$Vendor$Graph$NodeContext = F3(
	function (node, incoming, outgoing) {
		return {dg: incoming, dp: node, h: outgoing};
	});
				...
				return $jfmengels$elm_review$Vendor$IntDict$Inner(
					{
						...
						g: p,
						e: r,
						cM: $jfmengels$elm_review$Vendor$IntDict$size(l) + $jfmengels$elm_review$Vendor$IntDict$size(r)
					});
			}
		}
	});
var $jfmengels$elm_review$Vendor$IntDict$lcp = F2(
	function (x, y) {
		...
		return {a3: branchingBit, an: prefixBits};
	});
...
var $jfmengels$elm_review$Vendor$Graph$fromNodesAndEdges = F2(
	function (nodes_, edges_) {
			...
			function (edge, rep) {
				var updateOutgoing = function (ctx) {
					return _Utils_update(
						ctx,
						{
							h: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.eR, edge.cB, ctx.h)
						});
				};
				var updateIncoming = function (ctx) {
					return _Utils_update(
						ctx,
						{
							dg: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.ec, edge.cB, ctx.dg)
						});
				};
				return A3(
					$jfmengels$elm_review$Vendor$IntDict$update,
		...
		var addEdgeIfValid = F2(
			function (edge, rep) {
				return (A2($jfmengels$elm_review$Vendor$IntDict$member, edge.ec, rep) && A2($jfmengels$elm_review$Vendor$IntDict$member, edge.eR, rep)) ? A2(addEdge, edge, rep) : rep;
			});
...
var $jfmengels$elm_review$Vendor$Graph$Edge = F3(
	function (from, to, label) {
		return {ec: from, cB: label, eR: to};
	});
var $jfmengels$elm_review$Vendor$Graph$Node = F2(
	function (id, label) {
		return {bY: id, cB: label};
	});
...
var $jfmengels$elm_review$Review$Project$Internal$moduleGraph = function (_v0) {
	...
	if (!_v1.$) {
		...
		return $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(project.am));
	}
};
...
var $jfmengels$elm_review$Review$Project$Internal$moduleNameLookupTables = function (_v0) {
	var project = _v0;
	return A2($elm$core$Maybe$withDefault, $elm$core$Dict$empty, project.em);
};
var $jfmengels$elm_review$Review$Project$modules = function (_v0) {
	var project = _v0;
	return $elm$core$Dict$values(project.am);
};
	...
	function (cutOffLine, comments) {
		...
		while (true) {
			if (!comments.b) {
				...
				if (_Utils_cmp(range.bo.aJ, cutOffLine) > 0) {
					return $elm$core$Maybe$Nothing;
				} else {
...
var $jfmengels$elm_review$Review$Rule$findModuleDocumentation = function (ast) {
	var cutOffLine = function () {
		...
		if (_v0.b) {
			...
			return $stil4m$elm_syntax$Elm$Syntax$Node$range(firstImport).bo.aJ;
		} else {
			var _v1 = ast.c0;
			if (_v1.b) {
				var firstDeclaration = _v1.a;
				return $stil4m$elm_syntax$Elm$Syntax$Node$range(firstDeclaration).bo.aJ;
			} else {
				return 0;
			}
		}
	}();
	return A2($jfmengels$elm_review$Review$Rule$findModuleDocumentationBeforeCutOffLine, cutOffLine, ast.d2);
};
...
var $jfmengels$elm_review$Review$Rule$computeModules = F7(
	function (projectVisitor, _v0, project, exceptions, initialProjectContext, nodeContexts, startCache) {
		...
		var computeModule = F3(
			function (cache, importedModules, module_) {
				var availableData = {
					dW: module_.dW,
					bW: function () {
						var _v4 = projectVisitor.H;
						var requestedData = _v4;
						return requestedData.bn ? $jfmengels$elm_review$Review$Rule$extractSourceCode(
							$elm$core$String$lines(module_.eI)) : $elm$core$Basics$always('');
					}(),
					cs: module_.eA,
					cA: module_.cA,
					b4: module_.eA,
					al: A2(
						...
						$jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(
								$jfmengels$elm_review$Review$Rule$moduleNameNode(module_.dW.el))),
						A2(
							$elm$core$Dict$get,
							$jfmengels$elm_review$Review$Project$Internal$getModuleName(module_),
							...
							A2(
								...
								function (importedModule) {
									return A2(
										...
										A2($elm$core$Dict$get, importedModule.eA, cache));
								},
								importedModules));
				...
				return {
					f: function () {
						var _v2 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aK);
						if (!_v2.$) {
							var fromModuleToProject = _v2.a.aQ;
		...
		return A3(
			$elm$core$List$foldl,
			A4($jfmengels$elm_review$Review$Rule$computeModuleAndCacheResult, projectVisitor.aK, modules, graph, computeModule),
...
var $jfmengels$elm_review$Review$Project$directDependencies = function (_v0) {
	var project = _v0;
	var _v1 = A2(
		$elm$core$Maybe$map,
		function ($) {
	...
	if (!_v1.$) {
		if (!_v1.a.$) {
			var depsDirect = _v1.a.a.c3;
			var testDepsDirect = _v1.a.a.dL;
			var allDeps = A2(
				$elm$core$List$map,
				function (_v3) {
					var name = _v3.a;
...
var $jfmengels$elm_review$Review$Rule$computeProjectContext = F3(
	function (projectVisitor, project, maybePreviousCache) {
		...
		var elmJsonData = A2(
			$elm$core$Maybe$map,
			function (elmJson) {
				return {d7: elmJson, c: elmJson.c};
			},
			projectElmJson);
		var elmJsonCacheEntry = function () {
			var computeElmJson = function (_v10) {
				var _v9 = A3(
					$jfmengels$elm_review$Review$Rule$accumulateWithListOfVisitors,
					projectVisitor.A,
					elmJsonData,
					_Utils_Tuple2(_List_Nil, projectVisitor.aF));
				var errorsForVisitor = _v9.a;
				var contextForVisitor = _v9.b;
				return {f: contextForVisitor, aC: errorsForVisitor, cf: projectElmJson};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return _Utils_eq(previousCache.bR.cf, projectElmJson) ? previousCache.bR : computeElmJson(0);
			} else {
				return computeElmJson(0);
			}
		}();
		var readmeCacheEntry = function () {
			var computeReadme = function (_v7) {
				var _v6 = A3(
					$jfmengels$elm_review$Review$Rule$accumulateWithListOfVisitors,
					projectVisitor.D,
					readmeData,
					_Utils_Tuple2(_List_Nil, elmJsonCacheEntry.f));
				var errorsForVisitor = _v6.a;
				var contextForVisitor = _v6.b;
				return {f: contextForVisitor, aC: errorsForVisitor, cf: readmeData};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.bR.f, elmJsonCacheEntry.f) && _Utils_eq(previousCache.cI.cf, readmeData)) ? previousCache.cI : computeReadme(0);
			} else {
		...
		var _v0 = function () {
			...
			var computeDependencies = function (_v4) {
				var accumulateWithDirectDependencies = function () {
					var _v3 = projectVisitor.z;
					if (!_v3.b) {
						...
						return A2(
							$jfmengels$elm_review$Review$Rule$accumulateWithListOfVisitors,
							visitors,
							$jfmengels$elm_review$Review$Project$directDependencies(project));
					}
				}();
				var _v2 = A3(
					$jfmengels$elm_review$Review$Rule$accumulateWithListOfVisitors,
				...
				return {f: contextForVisitor, aC: errorsForVisitor, cf: dependencies};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.cI.f, readmeCacheEntry.f) && _Utils_eq(previousCache.ag.cf, dependencies)) ? _Utils_Tuple2(previousCache.ag, false) : _Utils_Tuple2(
		...
		return _Utils_Tuple2(
			{ag: dependenciesCacheEntry, bR: elmJsonCacheEntry, bA: _List_Nil, bH: $elm$core$Dict$empty, cI: readmeCacheEntry},
			hasAnythingChanged);
	});
	...
	return $elm$core$List$concat(
		_List_fromArray(
			[
				...
				$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
				function (cacheEntry) {
					return cacheEntry.aC;
				},
				$elm$core$Dict$values(cache.bH)),
				cache.bA
			]));
};
var $jfmengels$elm_review$Review$Rule$errorsFromFinalEvaluationForProject = F3(
	function (projectVisitor, initialContext, contextsPerModule) {
		var finalContext = function () {
			var _v0 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aK);
			if (!_v0.$) {
				var foldProjectContexts = _v0.a.au;
	...
	function (name, projectVisitor, maybePreviousCache, exceptions, project, nodeContexts) {
		...
		var previousModuleContexts = function () {
			if (hasInitialContextChanged) {
				...
				if (!maybePreviousCache.$) {
					var moduleContexts = maybePreviousCache.a.bH;
		...
		var contextsAndErrorsPerModule = A2(
			$elm$core$List$map,
			function (cacheEntry) {
				return _Utils_Tuple2(cacheEntry.aC, cacheEntry.f);
			},
		...
		var errorsFromFinalEvaluation = function () {
			if ($elm$core$List$isEmpty(projectVisitor.m)) {
				...
				if (!maybePreviousCache.$) {
					var previousCache = maybePreviousCache.a;
					return _Utils_eq(allModulesContext, previousAllModulesContext) ? previousCache.bA : A3($jfmengels$elm_review$Review$Rule$errorsFromFinalEvaluationForProject, projectVisitor, initialContext, allModulesContext);
				} else {
		...
		var newCache = {ag: cacheWithInitialContext.ag, bR: cacheWithInitialContext.bR, bA: errorsFromFinalEvaluation, bH: newCachedModuleContexts, cI: cacheWithInitialContext.cI};
		var errors = A3(
			$jfmengels$elm_review$Review$Exceptions$apply,
			exceptions,
			A2(
		...
		return {
			...
			aC: A2(
				...
				errors),
			a8: function () {
				var _v1 = projectVisitor.az;
				if (!_v1.$) {
					var dataExtractor = _v1.a;
					var contextToAnalyze = function () {
						var _v2 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aK);
						if (!_v2.$) {
							var foldProjectContexts = _v2.a.au;
				...
				ao: F3(
					function (newExceptions, newProject, newNodeContexts) {
						var result = A6(
							...
							newProject,
							newNodeContexts);
						return _Utils_Tuple2(result.aC, result.cJ);
					})
			}
		};
	});
				...
				F3(
					function (metadata, lookupTable, projectContext) {
						...
						return {
							...
							be: configuration.b6(moduleName),
							bG: _List_Nil,
							j: lookupTable
						};
					}))));
...
var $jfmengels$elm_review_common$NoDeprecated$registerAliasDeclaration = F3(
	function (_v0, type_, context) {
		var configuration = _v0;
		var name = $stil4m$elm_syntax$Elm$Syntax$Node$value(type_.a$);
		return (A2(configuration.aA, context.aM, name) || A2($jfmengels$elm_review_common$NoDeprecated$checkDocumentation, configuration.ar, type_.cm)) ? A2($jfmengels$elm_review_common$NoDeprecated$registerElement, name, context) : context;
	});
			...
			return A3(
				...
				function (_v2) {
					...
					return $jfmengels$elm_review_common$NoDeprecated$registerElement(
						$stil4m$elm_syntax$Elm$Syntax$Node$value(constructor.a$));
				},
				A2($jfmengels$elm_review_common$NoDeprecated$registerElement, name, ctx),
				type_.d3);
		};
		return (A2(configuration.aA, context.aM, name) || A2($jfmengels$elm_review_common$NoDeprecated$checkDocumentation, configuration.ar, type_.cm)) ? register(context) : A3(
			$elm$core$List$foldl,
			F2(
				function (_v1, ctx) {
					...
					return A2(
						configuration.aA,
						ctx.aM,
						$stil4m$elm_syntax$Elm$Syntax$Node$value(constructor.a$)) ? A2(
...
var $jfmengels$elm_review_common$NoDeprecated$registerFunctionDeclaration = F3(
	function (_v0, declaration, context) {
		...
		var name = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$stil4m$elm_syntax$Elm$Syntax$Node$value(declaration.d5).a$);
		return (A2(configuration.aA, context.aM, name) || A2($jfmengels$elm_review_common$NoDeprecated$checkDocumentation, configuration.ar, declaration.cm)) ? A2($jfmengels$elm_review_common$NoDeprecated$registerElement, name, context) : context;
	});
...
var $jfmengels$elm_review_common$NoDeprecated$rangeForNamedPattern = F2(
	function (_v0, _v1) {
		...
		var moduleName = _v1.b5;
		var name = _v1.a$;
		var patternStart = parentRange.bo;
		...
		return {
			a6: {ay: patternStart.ay + lengthForName, aJ: patternStart.aJ},
			bo: patternStart
		};
	});
...
var $jfmengels$elm_review$Review$Rule$error = F2(
	function (_v0, range) {
		...
		var details = _v0.bO;
		return $jfmengels$elm_review$Review$Rule$UnspecifiedError(
			{bO: details, cs: '', cu: $elm$core$Maybe$Nothing, aw: message, cH: range, cK: '', dJ: 0});
	});
var $jfmengels$elm_review_common$NoDeprecated$error = F2(
	function (origin, range) {
		...
		return A2(
			...
			{bO: details, aw: 'Found new usage of deprecated element'},
			range);
	});
var $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$toRangeLike = function (_v0) {
	...
	var end = _v0.a6;
	return _Utils_Tuple2(
		_Utils_Tuple2(start.aJ, start.ay),
		_Utils_Tuple2(end.aJ, end.ay));
};
...
var $jfmengels$elm_review_common$NoDeprecated$reportParameter = F3(
	function (_v0, range, name) {
		var configuration = _v0;
		return configuration.b8(name) ? $elm$core$Maybe$Just(
		...
		switch (_v0.$) {
			case 0:
				...
				var signatureErrors = function () {
					...
					if (!_v1.$) {
						...
						return A3(
							...
							_List_fromArray(
								[
									$stil4m$elm_syntax$Elm$Syntax$Node$value(signature).dO
								]),
							_List_Nil);
					} else {
						return _List_Nil;
				...
				var destructuringErrors = A4(
					...
					configuration,
					context,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(declaration.d5).cU,
					_List_Nil);
	...
	function (configuration, context, letDeclaration) {
		...
		if (!_v0.$) {
			...
			var destructuringErrors = A4(
				...
				configuration,
				context,
				$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d5).cU,
				_List_Nil);
			return _Utils_ap(destructuringErrors, signatureErrors);
		} else {
			var pattern = _v0.a;
		...
		if (moduleContext.be) {
			...
			if (!maybeModuleDocumentation.$) {
				...
				return _Utils_update(
					moduleContext,
					{
						be: configuration.ar(moduleDocumentation)
					});
			} else {
				return moduleContext;
			}
...
var $jfmengels$elm_review$Review$Rule$withDeclarationListVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				af: A2($elm$core$List$cons, visitor, schema.af)
			});
	});
...
var $jfmengels$elm_review$Review$Rule$withModuleDocumentationVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				ak: A2($elm$core$List$cons, visitor, schema.ak)
			});
	});
...
var $jfmengels$elm_review$Review$Rule$newProjectRuleSchema = F2(
	function (name, initialProjectContext) {
		return {az: $elm$core$Maybe$Nothing, y: _List_Nil, z: _List_Nil, A: _List_Nil, m: _List_Nil, aP: $elm$core$Maybe$Nothing, aF: initialProjectContext, I: $elm$core$Maybe$Nothing, bg: _List_Nil, a$: name, D: _List_Nil, bM: 0};
	});
var $jfmengels$elm_review_common$NoDeprecated$userConfigurationToStableConfiguration = F2(
	function (_v0, elementPredicate) {
		var configuration = _v0;
		return {aN: configuration.aN, ar: configuration.ar, aA: elementPredicate, b6: configuration.b6, b8: configuration.b8, b9: configuration.b9};
	});
		...
		return _Utils_update(
			schema,
			{
				aP: $elm$core$Maybe$Just(
					{au: functions.au, aQ: functions.aQ}),
				I: $elm$core$Maybe$Just(functions.cw)
			});
	});
	...
	if (!_v0.$) {
		...
		return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
			$jfmengels$elm_review$Review$Rule$withContextFromImportedModules(
				A2(
					...
					{
						au: $jfmengels$elm_review_common$NoDeprecated$foldProjectContexts,
						aQ: $jfmengels$elm_review_common$NoDeprecated$fromModuleToProject,
						cw: $jfmengels$elm_review_common$NoDeprecated$fromProjectToModule(stableConfiguration)
					},
					A2(
		...
		return A2(
			...
			'NoDeprecated',
			{
				...
				aw: 'Invalid exceptions provided in the configuration'
			});
	}
};
				...
				_List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aw: 'Module exposes everything implicitly \"(..)\"'
						},
						{
							a6: {ay: range.a6.ay + 1, aJ: range.a6.aJ},
							bo: {ay: range.bo.ay - 1, aJ: range.bo.aJ}
						},
						_List_fromArray(
							[
								A2(
		...
		return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
			{
				...
				z: A2($jfmengels$elm_review$Review$Rule$compactProjectDataVisitors, $elm$core$Basics$identity, schema.z),
				A: A2(
		...
		return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
			{
				...
				aP: $elm$core$Maybe$Nothing,
				aF: 0,
				I: $elm$core$Maybe$Just(schema.I),
				bg: _List_fromArray(
					[
						$jfmengels$elm_review$Review$Rule$removeExtensibleRecordTypeVariable(
						$elm$core$Basics$always(moduleVisitor))
...
var $stil4m$elm_syntax$Elm$Syntax$Module$exposingList = function (m) {
	switch (m.$) {
		case 0:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.cp);
		case 1:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.cp);
		default:
...
var $jfmengels$elm_review$Review$Rule$withModuleDefinitionVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				aj: A2($elm$core$List$cons, visitor, schema.aj)
			});
	});
...
var $jfmengels$elm_review_common$NoImportingEverything$moduleName = function (node) {
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(
		$stil4m$elm_syntax$Elm$Syntax$Node$value(node).b5);
};
	...
	function (exceptions, node) {
		if (A2(
			...
			var _v0 = A2(
				$elm$core$Maybe$map,
				$stil4m$elm_syntax$Elm$Syntax$Node$value,
				$stil4m$elm_syntax$Elm$Syntax$Node$value(node).cp);
			if ((!_v0.$) && (!_v0.a.$)) {
				var range = _v0.a.a;
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$error,
						{
							...
							aw: 'Prefer listing what you wish to import and/or using qualified imports'
						},
						{
							a6: {ay: range.a6.ay + 1, aJ: range.a6.aJ},
							bo: {ay: range.bo.ay - 1, aJ: range.bo.aJ}
...
var $jfmengels$elm_review$Review$Rule$withImportVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				ai: A2($elm$core$List$cons, visitor, schema.ai)
			});
	});
...
var $jfmengels$elm_review_common$NoMissingTypeAnnotation$declarationVisitor = function (declaration) {
	...
	if (!_v0.$) {
		...
		var _v1 = _function.eH;
		if (_v1.$ === 1) {
			var name = $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d5).a$;
			return _List_fromArray(
				[
					A2(
					$jfmengels$elm_review$Review$Rule$error,
					{
						...
						aw: 'Missing type annotation for `' + ($stil4m$elm_syntax$Elm$Syntax$Node$value(name) + '`')
					},
					$stil4m$elm_syntax$Elm$Syntax$Node$range(name))
				]);
		} else {
		...
		if (!maybeProject.$) {
			...
			return _Utils_Tuple2(
				...
				_Utils_update(
					context,
					{
						G: $jfmengels$elm_review_common$NoMissingTypeExpose$exposedModulesForElmJson(project)
					}));
		} else {
			return _Utils_Tuple2(_List_Nil, context);
		}
...
var $jfmengels$elm_review_common$NoMissingTypeExpose$foldProjectContexts = F2(
	function (_new, old) {
		return {
			G: A2($jfmengels$elm_review_common$NoMissingTypeExpose$foldExposedModules, _new.G, old.G),
			ax: A2($jfmengels$elm_review_common$NoMissingTypeExpose$foldModuleTypes, _new.ax, old.ax)
		};
	});
var $jfmengels$elm_review_common$NoMissingTypeExpose$initialProjectContext = {G: $jfmengels$elm_review_common$NoMissingTypeExpose$Application, ax: $elm$core$Dict$empty};
	...
	return A2(
		...
		function (data) {
			return A2(
				...
				data,
				$stil4m$elm_syntax$Elm$Syntax$Node$value(
					$jfmengels$elm_review$Review$Rule$moduleNameNode(data.dW.el)));
		},
		requestedData);
};
	...
	$jfmengels$elm_review$Review$Rule$initContextCreator(
		F2(
			function (moduleName, context) {
				var _v0 = context.P;
				if (!_v0.$) {
					var exposedTypes = _v0.a.bx;
					return _Utils_update(
						$jfmengels$elm_review_common$NoMissingTypeExpose$initialProjectContext,
						{
							ax: A2($elm$core$Dict$singleton, moduleName, exposedTypes)
						});
				} else {
		...
		return $jfmengels$elm_review_common$NoMissingTypeExpose$ExposedModule(
			{
				...
				G: exposedModules,
				bw: _List_Nil,
				as: $stil4m$elm_syntax$Elm$Syntax$Exposing$Explicit(_List_Nil),
		...
		$jfmengels$elm_review$Review$Rule$initContextCreator(
			F3(
				function (lookupTable, moduleName, _v0) {
					var exposedModules = _v0.G;
					var moduleTypes = _v0.ax;
...
var $jfmengels$elm_review_common$NoMissingTypeExpose$exposedSignatureTypesForDeclaration = F4(
	function (lookupTable, exposes, _v0, exposedSignatureTypes) {
		...
		switch (declaration.$) {
			case 2:
				var name = declaration.a.a$;
				var constructors = declaration.a.d3;
			...
			case 1:
				var name = declaration.a.a$;
				var typeAnnotation = declaration.a.dO;
			...
			case 0:
				var signature = declaration.a.eH;
		...
		return _Utils_Tuple2(
			...
			function () {
				...
				if (!_v0.$) {
					...
					return {
						j: context.j,
						P: $jfmengels$elm_review_common$NoMissingTypeExpose$InternalModule(
							_Utils_update(
								data,
								{
									bx: A3($jfmengels$elm_review_common$NoMissingTypeExpose$exposedTypesForDeclarationList, data.as, nodes, data.bx)
								})),
						J: context.J
					};
				} else {
					...
					return {
						j: context.j,
						P: $jfmengels$elm_review_common$NoMissingTypeExpose$ExposedModule(
							_Utils_update(
								data,
								{
									br: A2($jfmengels$elm_review_common$NoMissingTypeExpose$declaredTypesForDeclarationList, nodes, data.br),
									bw: A4($jfmengels$elm_review_common$NoMissingTypeExpose$exposedSignatureTypesForDeclarationList, context.j, data.as, nodes, data.bw)
								})),
						J: context.J
					};
				}
...
var $jfmengels$elm_review_common$NoMissingTypeExpose$isTypePrivate = F3(
	function (modulesFromTheProject, data, _v0) {
		...
		if (!typeCall.a.b) {
			var name = typeCall.b;
			return A2($elm$core$Set$member, name, data.br) && (!A2($jfmengels$elm_review_common$NoMissingTypeExpose$isTypeExposed, data.as, name));
		} else {
			var moduleName = typeCall.a;
			return A2($elm$core$Set$member, moduleName, modulesFromTheProject) && (!A2($jfmengels$elm_review_common$NoMissingTypeExpose$isModuleExposed, data.G, moduleName));
		}
	});
	...
	function (exposingListStart, _v0) {
		...
		return A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
				...
				aw: 'Private type `' + (formattedName + '` should be exposed')
			},
			range,
...
var $jfmengels$elm_review_common$NoMissingTypeExpose$finalEvaluation = function (context) {
	...
	if (!_v0.$) {
		...
		return A2(
			$elm$core$List$map,
			$jfmengels$elm_review_common$NoMissingTypeExpose$makeError(data.bU),
			A2(
				$elm$core$List$filter,
				A2($jfmengels$elm_review_common$NoMissingTypeExpose$isTypePrivate, context.J, data),
				data.bw));
	}
};
...
var $jfmengels$elm_review_common$NoMissingTypeExpose$importVisitor = F2(
	function (_v0, context) {
		var moduleName = _v0.b.b5;
		var moduleAlias = _v0.b.ek;
		var _v1 = context.P;
		if (!_v1.$) {
			return _Utils_Tuple2(_List_Nil, context);
		} else {
...
var $jfmengels$elm_review_common$NoMissingTypeExpose$exposingListStartLocation = function (exposes) {
	if ((exposes.$ === 1) && exposes.a.b) {
		...
		var _v2 = _v1.a;
		var range = _v2.a;
		return $elm$core$Maybe$Just(range.bo);
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
				...
				_List_Nil,
				{
					...
					P: $jfmengels$elm_review_common$NoMissingTypeExpose$InternalModule(
						_Utils_update(
							data,
							{
								as: $stil4m$elm_syntax$Elm$Syntax$Module$exposingList(mod)
							})),
					J: context.J
				});
		} else {
				...
				_List_Nil,
				{
					...
					P: $jfmengels$elm_review_common$NoMissingTypeExpose$ExposedModule(
						_Utils_update(
							...
							{
								as: $stil4m$elm_syntax$Elm$Syntax$Module$exposingList(mod),
								bU: $jfmengels$elm_review_common$NoMissingTypeExpose$exposingListStartLocation(
...
var $jfmengels$elm_review_common$NoMissingTypeExpose$rule = $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
	A2(
		$jfmengels$elm_review$Review$Rule$withModuleContextUsingContextCreator,
		{au: $jfmengels$elm_review_common$NoMissingTypeExpose$foldProjectContexts, aQ: $jfmengels$elm_review_common$NoMissingTypeExpose$fromModuleToProjectContext, cw: $jfmengels$elm_review_common$NoMissingTypeExpose$fromProjectToModuleContext},
		$jfmengels$elm_review$Review$Rule$withContextFromImportedModules(
			A2(
				$jfmengels$elm_review$Review$Rule$withModuleVisitor,
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$emptyBranching = {q: _List_Nil, aX: $elm$core$Maybe$Nothing};
	...
	if (_v0.$ === 15) {
		...
		if (declarations.b) {
			...
			return $jfmengels$elm_review_common$NoPrematureLetComputation$InsertExistingLet(
				$stil4m$elm_syntax$Elm$Syntax$Node$range(first).bo);
		} else {
			return $jfmengels$elm_review_common$NoPrematureLetComputation$InsertNewLet(
				$stil4m$elm_syntax$Elm$Syntax$Node$range(node).bo);
		}
	} else {
		return $jfmengels$elm_review_common$NoPrematureLetComputation$InsertNewLet(
			$stil4m$elm_syntax$Elm$Syntax$Node$range(node).bo);
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$newBranch = function (insertionLocation) {
	return A2(
		...
		0,
		{aV: insertionLocation, aH: _List_Nil, l: $jfmengels$elm_review_common$RangeDict$empty, aq: $elm$core$Set$empty});
};
var $jfmengels$elm_review_common$NoPrematureLetComputation$declarationVisitor = F2(
	function (node, context) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		if (!_v0.$) {
			var declaration = _v0.a.d5;
			return _Utils_Tuple2(
				_List_Nil,
				{
					o: $jfmengels$elm_review_common$NoPrematureLetComputation$emptyBranching,
					bW: context.bW,
					ba: $jfmengels$elm_review_common$RangeDict$empty,
					j: context.j,
					r: $jfmengels$elm_review_common$NoPrematureLetComputation$newBranch(
						$jfmengels$elm_review_common$NoPrematureLetComputation$figureOutInsertionLocation(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(declaration).bV))
				});
		} else {
			return _Utils_Tuple2(_List_Nil, context);
		}
...
var $jfmengels$elm_review_common$RangeDict$rangeAsString = function (range) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[range.bo.aJ, range.bo.ay, range.a6.aJ, range.a6.ay])));
};
...
var $stil4m$elm_syntax$Elm$Syntax$Range$compareLocations = F2(
	function (left, right) {
		return (_Utils_cmp(left.aJ, right.aJ) < 0) ? 0 : ((_Utils_cmp(left.aJ, right.aJ) > 0) ? 2 : A2($elm$core$Basics$compare, left.ay, right.ay));
	});
var $jfmengels$elm_review_common$NoPrematureLetComputation$isRangeContained = function (_v0) {
	var outer = _v0.dr;
	var inner = _v0.dh;
	return (A2($stil4m$elm_syntax$Elm$Syntax$Range$compareLocations, outer.bo, inner.bo) !== 2) && (!(!A2($stil4m$elm_syntax$Elm$Syntax$Range$compareLocations, outer.a6, inner.a6)));
};
var $jfmengels$elm_review_common$NoPrematureLetComputation$markDeclarationAsUsed = F2(
	function (range, declared) {
		return $jfmengels$elm_review_common$NoPrematureLetComputation$isRangeContained(
			{dh: range, dr: declared.bq}) ? _Utils_update(
			declared,
			{bZ: true}) : declared;
	});
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$collectDeclarations = function (node) {
	...
	if (!_v0.$) {
		...
		var declaration = $stil4m$elm_syntax$Elm$Syntax$Node$value(letFunction.d5);
		return $elm$core$List$isEmpty(declaration.cU) ? _List_fromArray(
			[
				_Utils_Tuple3(
				declaration.a$,
				$stil4m$elm_syntax$Elm$Syntax$Node$range(declaration.bV),
				node)
			]) : _List_Nil;
	} else {
		var pattern = _v0.a;
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$functionScope = A2(
	...
	2,
	{
		aV: $jfmengels$elm_review_common$NoPrematureLetComputation$InsertNewLet(
			{ay: 0, aJ: 0}),
		aH: _List_Nil,
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$getLetFunctionRange = function (node) {
	...
	if (!_v0.$) {
		...
		return $elm$core$List$isEmpty(
			$stil4m$elm_syntax$Elm$Syntax$Node$value(declaration).cU) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$registerLetExpression = F3(
	function (node, _v0, context) {
		var declarations = _v0.c0;
		var expression = _v0.bV;
		...
		var letDeclarations = A2(
			...
			function (_v1) {
				...
				return {
					ck: $stil4m$elm_syntax$Elm$Syntax$Node$range(declaration).bo.ay,
					bq: $jfmengels$elm_review_common$NoPrematureLetComputation$fullLines(
						{
							a6: expressionRange.a6,
							bo: $stil4m$elm_syntax$Elm$Syntax$Node$range(declaration).bo
						}),
					bZ: false,
					a$: $stil4m$elm_syntax$Elm$Syntax$Node$value(nameNode),
					cb: isDeclarationAlone ? {
						a6: $stil4m$elm_syntax$Elm$Syntax$Node$range(expression).bo,
						bo: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).bo
					} : {
						a6: expressionRange.a6,
						bo: {
							ay: 1,
							aJ: $stil4m$elm_syntax$Elm$Syntax$Node$range(declaration).bo.aJ
						}
					},
					cc: $stil4m$elm_syntax$Elm$Syntax$Node$range(nameNode)
				};
			},
		...
		var newScope = A2(
			...
			1,
			{
				aV: $jfmengels$elm_review_common$NoPrematureLetComputation$figureOutInsertionLocation(node),
				aH: letDeclarations,
				l: scopes,
				aq: $elm$core$Set$empty
			});
						...
						var branch = A3(
							...
							function (b) {
								return _Utils_update(
									b,
									{
										aq: A2($elm$core$Set$insert, name, b.aq)
									});
							},
							context.o.q,
							context.r);
				...
				case 17:
					...
					var newScope = A2(
						...
						A2(
							...
							context.ba) ? 3 : 2,
						{
							aV: $jfmengels$elm_review_common$NoPrematureLetComputation$figureOutInsertionLocation(expression),
							aH: _List_Nil,
							l: $jfmengels$elm_review_common$RangeDict$empty,
							aq: $elm$core$Set$empty
						});
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$canBeMovedToCloserLocationForBranchData = F3(
	function (isRoot, name, branchData) {
		if (A2($elm$core$Set$member, name, branchData.aq)) {
			return A2(
	...
	function (context, declared, letInsertPosition) {
		if (declared.bZ) {
			...
			if (!letInsertPosition.$) {
				...
				return _List_fromArray(
					[
						$jfmengels$elm_review$Review$Fix$removeRange(declared.cb),
						A2(
	...
	function (context, declared, letInsertPosition) {
		...
		return A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
				...
				aw: 'Let value was declared prematurely'
			},
			declared.cc,
				...
				return A2(
					...
					function (declaration) {
						return A2(
							...
							$elm$core$List$head(
								A3($jfmengels$elm_review_common$NoPrematureLetComputation$canBeMovedToCloserLocation, true, declaration.a$, scope)));
					},
					scopeData.aH);
			} else {
				return _List_Nil;
...
var $jfmengels$elm_review_common$NoPrematureLetComputation$removeLastBranchIfOnItRetry = F2(
	function (range, branching) {
		if (_Utils_eq(
			...
			return {
				q: full,
				aX: $jfmengels$elm_review_common$NoPrematureLetComputation$getLastListItem(full)
			};
		} else {
			return branching;
		}
...
var $jfmengels$elm_review$Review$Rule$newModuleRuleSchemaUsingContextCreator = F2(
	function (name, moduleContextCreator) {
		return {U: _List_Nil, V: _List_Nil, ac: _List_Nil, af: _List_Nil, W: _List_Nil, X: _List_Nil, y: _List_Nil, z: _List_Nil, A: _List_Nil, v: _List_Nil, C: _List_Nil, m: _List_Nil, ai: _List_Nil, bD: $elm$core$Maybe$Nothing, _: _List_Nil, aa: _List_Nil, I: moduleContextCreator, aj: _List_Nil, ak: _List_Nil, a$: name, D: _List_Nil};
	});
var $jfmengels$elm_review$Review$Rule$withExpressionExitVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				C: A2($elm$core$List$cons, visitor, schema.C)
			});
	});
							...
							return function (ignoredFiles) {
								return function (writeSuppressionFiles) {
									return function (logger) {
										return {O: detailsMode, a9: fixMode, bc: ignoreProblematicDependencies, cx: ignoredDirs, cy: ignoredFiles, av: logger, a1: reportMode, cL: rulesFilter, ab: unsuppressMode, bp: writeSuppressionFiles};
									};
								};
							};
						};
...
var $author$project$Elm$Review$Main$decodeFlags = A3(
	...
	'logger',
	$author$project$Elm$Review$Progress$decoder,
	A3(
		$author$project$Elm$Review$Main$field,
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'column',
				$elm$json$Json$Encode$int(position.ay))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'start',
				$author$project$Elm$Review$Main$encodePosition(range.bo)),
				_Utils_Tuple2(
				'end',
				$author$project$Elm$Review$Main$encodePosition(range.a6))
			]));
};
...
var $author$project$Elm$Review$Text$from = function (value) {
	return {d0: $elm$core$Maybe$Nothing, ee: $elm$core$Maybe$Nothing, eK: value};
};
					...
					A2(
						...
						_List_fromArray(
							[
								...
								gutterLength,
								{a6: end.ay, b$: lineContent, bo: start.ay}),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							gutterLength,
							{
								a6: $elm$core$List$length(
									$elm$core$String$toList(startLineContent)) + 1,
								b$: startLineContentWithLineNumber,
								bo: start.ay
							}),
							A2(
							$author$project$Elm$Review$Text$join,
							...
							{
								a6: end.ay,
								b$: endLineContentWithLineNumber,
								bo: $author$project$Elm$Review$Reporter$getIndexOfFirstNonSpace(endLineContent) + 1
							}),
			...
			A4(
				...
				_List_fromArray(
					[
						...
						error.dx,
						$author$project$Elm$Review$Text$inRed(
							$author$project$Elm$Review$Text$from(error.cK))),
						$author$project$Elm$Review$Text$from(': ' + error.aw)
					])));
	});
			...
			if (!detailsMode) {
				return A2(
					...
					A2(
						$elm$core$List$intersperse,
						$author$project$Elm$Review$Text$from('\n\n'),
						A2($elm$core$List$map, $author$project$Elm$Review$Text$from, error.bO)));
			} else {
				return _List_Nil;
			}
		}();
		var codeExtract_ = function () {
			var _v0 = A2($author$project$Elm$Review$Reporter$codeExtract, source, error.cH);
			if (!_v0.b) {
				return _List_Nil;
			} else {
	...
	function (previousTexts, lastText, chunks) {
		...
		while (true) {
			if (!chunks.b) {
				...
				if (_Utils_eq(lastText.d0, newLastText.d0) && _Utils_eq(lastText.ee, newLastText.ee)) {
					var $temp$previousTexts = previousTexts,
						$temp$lastText = {
						d0: lastText.d0,
						ee: lastText.ee,
						eK: _Utils_ap(lastText.eK, newLastText.eK)
					},
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'rule',
					$elm$json$Json$Encode$string(error.cK)),
					_Utils_Tuple2(
					'message',
					$elm$json$Json$Encode$string(error.aw)),
					_Utils_Tuple2(
					'details',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, error.bO)),
					_Utils_Tuple2(
					'region',
			...
			if (!errors.b) {
				...
				if (isInvalid) {
					var $temp$fixProblemDict = fixProblemDict,
						...
						$temp$acc = {
						aR: acc.aR,
						aG: A2($elm$core$List$cons, error, acc.aG)
					};
...
var $author$project$Elm$Review$Reporter$classifyFixes = F2(
	function (fixProblemDict, errors) {
		var _v0 = A3(
			...
			fixProblemDict,
			errors,
			{aR: false, aG: _List_Nil});
		var invalidFixableErrors = _v0.aG;
		var hasIgnoredFixableErrors = _v0.aR;
		return {
			aR: hasIgnoredFixableErrors,
			aG: $elm$core$List$reverse(invalidFixableErrors)
		};
	});
...
var $author$project$Elm$Review$Reporter$compareRange = F2(
	function (a, b) {
		return (_Utils_cmp(a.bo.aJ, b.bo.aJ) < 0) ? 0 : ((_Utils_cmp(a.bo.aJ, b.bo.aJ) > 0) ? 2 : ((_Utils_cmp(a.bo.ay, b.bo.ay) < 0) ? 0 : ((_Utils_cmp(a.bo.ay, b.bo.ay) > 0) ? 2 : ((_Utils_cmp(a.a6.aJ, b.a6.aJ) < 0) ? 0 : ((_Utils_cmp(a.a6.aJ, b.a6.aJ) > 0) ? 2 : ((_Utils_cmp(a.a6.ay, b.a6.ay) < 0) ? 0 : ((_Utils_cmp(a.a6.ay, b.a6.ay) > 0) ? 2 : 1)))))));
	});
var $author$project$Elm$Review$Reporter$compareErrorPositions = F2(
	function (a, b) {
		return A2($author$project$Elm$Review$Reporter$compareRange, a.cH, b.cH);
	});
	...
	function (isFirstError, filePath_, range) {
		var position = function () {
			switch (filePath_.$) {
				case 0:
					var str = filePath_.a;
					return ' ' + (str + (':' + ($elm$core$String$fromInt(range.bo.aJ) + (':' + $elm$core$String$fromInt(range.bo.ay)))));
				case 1:
					return ' GLOBAL ERROR';
				default:
						...
						return A2(
							...
							_List_fromArray(
								[
									_List_fromArray(
									[
										A3($author$project$Elm$Review$Reporter$header, !index, file.eA, error.cH)
									]),
									A5($author$project$Elm$Review$Reporter$formatErrorWithExtract, fixProblemDict, detailsMode, mode, file.eI, error)
								]));
					}),
				A2($elm$core$List$sortWith, $author$project$Elm$Review$Reporter$compareErrorPositions, file.aC)));
	});
				...
				return $elm$core$List$concat(
					_List_fromArray(
						[
							...
							A2($author$project$Elm$Review$Reporter$fileSeparator, firstFile.eA, secondFile.eA),
							A3(
				...
				return A2(
					...
					function (file) {
						return A2(
							$elm$core$List$any,
							function (error) {
								return error.dH && (!A2($elm$core$Set$member, error.cK, set));
							},
							file.aC);
					},
					files);
	...
	function (files, acc) {
		...
		while (true) {
			if (!files.b) {
				...
				var xs = files.b;
				var $temp$files = xs,
					$temp$acc = acc + $elm$core$List$length(file.aC);
				files = $temp$files;
				acc = $temp$acc;
...
var $author$project$Elm$Review$Reporter$formatReport = F2(
	function (_v0, files) {
		...
		var unsuppressMode = _v0.ab;
		var originalNumberOfSuppressedErrors = _v0.bi;
		var detailsMode = _v0.O;
		var errorsHaveBeenFixedPreviously = _v0.a7;
		var fixProblemDict = _v0.c9;
		...
		if (!numberOfErrors) {
			...
			var invalidFixableErrors = _v1.aG;
			var hasIgnoredFixableErrors = _v1.aR;
			return A2(
				$elm$core$List$map,
				$author$project$Elm$Review$Text$toRecord,
				$author$project$Elm$Review$Text$simplify(
...
var $author$project$Elm$Review$Main$getConfigurationError = function (rule) {
	...
	if (!_v0.$) {
		...
		return $elm$core$Maybe$Just(
			{
				bO: configurationError.bO,
				da: $elm$core$Maybe$Nothing,
				aw: configurationError.aw,
				cH: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
				dx: $elm$core$Maybe$Nothing,
				cK: $jfmengels$elm_review$Review$Rule$ruleName(rule),
				dH: false
			});
	} else {
		return $elm$core$Maybe$Nothing;
...
var $jfmengels$elm_review$Review$Rule$ignoreErrorsForDirectories = F2(
	function (directories, _v0) {
		...
		return {
			ad: rule.ad,
			ah: A2($jfmengels$elm_review$Review$Exceptions$addDirectories, directories, rule.ah),
			a$: rule.a$,
			H: rule.H,
			ao: rule.ao
		};
...
var $jfmengels$elm_review$Review$Rule$ignoreErrorsForFiles = F2(
	function (files, _v0) {
		...
		return {
			ad: rule.ad,
			ah: A2($jfmengels$elm_review$Review$Exceptions$addFiles, files, rule.ah),
			a$: rule.a$,
			H: rule.H,
			ao: rule.ao
		};
...
var $author$project$Elm$Review$Main$unknownRulesFilterMessage = function (_v0) {
	var ruleNames = _v0.dy;
	var filterNames = _v0.c8;
	var unknownRulesMessage = A2(
		...
		A2(
			...
			filterNames));
	return {aw: 'You requested to only run several rules, but I could not find some of them.\n\n' + unknownRulesMessage, bL: 'UNKNOWN FILTERED RULE(S)'};
};
var $author$project$Elm$Review$Main$init = function (rawFlags) {
	var _v0 = function () {
		...
		if (!_v1.$) {
			...
			var error = _v1.a;
			return _Utils_Tuple2(
				{O: 1, a9: 0, bc: false, cx: _List_Nil, cy: _List_Nil, av: $author$project$Elm$Review$Progress$dummy, a1: 0, cL: $elm$core$Maybe$Nothing, ab: $author$project$Elm$Review$UnsuppressMode$UnsuppressNone, bp: false},
	...
	var rules = A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$jfmengels$elm_review$Review$Rule$ignoreErrorsForDirectories(flags.cx),
			$jfmengels$elm_review$Review$Rule$ignoreErrorsForFiles(flags.cy)),
		rulesFromConfig);
	return _Utils_Tuple2(
		{O: flags.O, aB: $author$project$Elm$Review$Main$NotAwaiting, a7: false, at: $elm$core$Dict$empty, ct: $jfmengels$elm_review$Review$Project$new, a9: flags.a9, bc: flags.bc, aY: $elm$core$Dict$empty, av: flags.av, bi: 0, c: $jfmengels$elm_review$Review$Project$new, bK: $elm$core$Maybe$Nothing, bl: $author$project$Elm$Review$RefusedErrorFixes$empty, a1: flags.a1, a2: _List_Nil, S: _List_Nil, bm: rules, E: $author$project$Elm$Review$SuppressedErrors$empty, ab: flags.ab, bp: flags.bp},
		function () {
			if ($elm$core$List$isEmpty($author$project$ReviewConfig$config)) {
				return $author$project$Elm$Review$Main$abortWithDetails(
					{aw: 'Your configuration contains no rules. You can add rules by editing the ReviewConfig.elm file.\n\nI recommend you take a look at the following documents:\n  - How to configure elm-review: https://github.com/jfmengels/elm-review/#Configuration\n  - When to write or enable a rule: https://github.com/jfmengels/elm-review/#when-to-write-or-enable-a-rule', bL: 'CONFIGURATION IS EMPTY'});
			} else {
								...
								if (!_v5) {
									return $author$project$Elm$Review$Main$encodeReport(
										A2(
											...
											{O: flags.O, a7: false, c9: $elm$core$Dict$empty, bi: 0, E: $author$project$Elm$Review$SuppressedErrors$empty, ab: flags.ab},
											_List_fromArray(
												[
													{aC: configurationErrors, eA: $author$project$Elm$Review$Reporter$ConfigurationError, eI: ''}
												])));
								} else {
									return A2($author$project$Elm$Review$Main$encodeConfigurationErrors, flags.O, configurationErrors);
								}
							}());
					}
				}
...
var $jfmengels$elm_review$Review$Project$addElmJson = F2(
	function (elmJson_, _v0) {
		...
		var modules_ = _Utils_eq(project.cN, sourceDirectories) ? project.am : A2(
			$elm$core$Dict$map,
			F2(
				function (_v1, value) {
					var osAgnosticPath = $jfmengels$elm_review$Review$Project$makePathOSAgnostic(value.eA);
					return _Utils_update(
						value,
						{
							cA: A2(
			...
			d2: A2(
				...
				A2(
					...
					A2(
						...
						$jfmengels$elm_review$Review$Project$positionAsInt)),
				ast.d2)
		});
};
var $jfmengels$elm_review$Review$Project$sanitizeModule = function (module_) {
	return _Utils_update(
		module_,
		{
			dW: $jfmengels$elm_review$Review$Project$reorderComments(module_.dW)
		});
};
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'apL'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<|'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'apR'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|>'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'or'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '||'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'and'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '&&'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 3)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'eq'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '=='),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'neq'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '/='),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'lt'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'gt'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'le'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<='),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'ge'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>='),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'append'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '++'),
						...
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'add'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '+'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'sub'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '-'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'mul'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '*'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'fdiv'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '/'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'idiv'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '//'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'pow'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '^'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 8)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'composeL'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<<'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 9)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'composeR'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>>'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 9)
						})
					])),
				...
				_List_fromArray(
					[
						...
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'cons'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '::'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
						})
					]))
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'keeper'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|='),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'ignorer'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|.'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						})
					])),
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'slash'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '</>'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'questionMark'),
							ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<?>'),
							eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 8)
						})
					]))
...
var $stil4m$elm_syntax$Elm$Parser$State$emptyState = {d2: _List_Nil, aU: _List_Nil};
var $stil4m$elm_syntax$Elm$Syntax$File$File = F4(
	function (moduleDefinition, imports, declarations, comments) {
		return {d2: comments, c0: declarations, ef: imports, el: moduleDefinition};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$getComments = function (_v0) {
	var s = _v0;
	return $elm$core$List$reverse(s.d2);
};
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$LetBlock = F2(
	function (declarations, expression) {
		return {c0: declarations, bV: expression};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {c_: col, d4: contextStack, dt: problem, aJ: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aJ, s.c_, x, s.f));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aJ, s.c_, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{c_: newCol, f: s.f, i: s.i, b: newOffset, aJ: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{c_: 1, f: s.f, i: s.i, b: s.b + 1, aJ: s.aJ + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{c_: s.c_ + 1, f: s.f, i: s.i, b: newOffset, aJ: s.aJ, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{c_: col, f: s0.f, i: s0.i, b: offset, aJ: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aJ, s.c_, s);
	};
};
						...
						return $stil4m$elm_syntax$Combine$succeed(
							{
								...
								bo: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(start)
							});
					}),
				A2(
					$stil4m$elm_syntax$Combine$andMap,
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {c_: col, f: context, i: indent, b: offset, aJ: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
	...
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.c6));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.dh, s.b + 1, s.aJ + 1, 1, s.a, s.i, s.f) : A7($elm$parser$Parser$Advanced$varHelp, i.dh, firstOffset, s.aJ, s.c_ + 1, s.a, s.i, s.f);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.dw) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.c6)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{c6: $elm$parser$Parser$ExpectingVariable, dh: i.dh, dw: i.dw, bo: i.bo});
};
	...
	$elm$parser$Parser$variable(
		{
			...
			dw: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			bo: $miniBill$elm_unicode$Unicode$isLower
		}));
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.aJ, s.c_, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.aJ, s.c_, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $stil4m$elm_syntax$Elm$Parser$State$addComment = F2(
	function (pair, _v0) {
		...
		return _Utils_update(
			s,
			{
				d2: A2($elm$core$List$cons, pair, s.d2)
			});
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {c_: s.c_ + (newOffset - s.b), f: s.f, i: s.i, b: newOffset, aJ: s.aJ, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.aJ, s.c_ - (floatOffset + s.b), invalid, s.f));
		} else {
...
var $elm$parser$Parser$number = function (i) {
	return $elm$parser$Parser$Advanced$number(
		{
			cW: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingBinary, i.cW),
			c6: $elm$parser$Parser$ExpectingNumber,
			db: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.db),
			df: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.df),
			di: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.di),
			ei: $elm$parser$Parser$ExpectingNumber,
			dq: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingOctal, i.dq)
		});
};
		...
		return $elm$parser$Parser$number(
			{
				...
				df: $elm$core$Maybe$Just(hexf),
				di: $elm$core$Maybe$Just(intf),
	...
	$elm$parser$Parser$variable(
		{
			...
			dw: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			bo: $miniBill$elm_unicode$Unicode$isUpper
		}));
				...
				if (!_v0.$) {
					...
					return A2(
						...
						function (_v3) {
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d5).a$),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var value = _v1.b;
...
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {a$: name, dO: typeAnnotation};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$popIndent = function (_v0) {
	...
	return _Utils_update(
		s,
		{
			aU: A2($elm$core$List$drop, 1, s.aU)
		});
};
var $stil4m$elm_syntax$Elm$Parser$State$pushIndent = F2(
	function (x, _v0) {
		...
		return _Utils_update(
			s,
			{
				aU: A2($elm$core$List$cons, x, s.aU)
			});
	});
					...
					function (s) {
						return $stil4m$elm_syntax$Combine$withLocation(
							function (l) {
								return _Utils_eq(
									$stil4m$elm_syntax$Elm$Parser$State$expectedColumn(s),
									l.ay) ? $stil4m$elm_syntax$Combine$choice(
									_List_fromArray(
										[
											A2(
											$stil4m$elm_syntax$Combine$map,
...
var $stil4m$elm_syntax$Elm$Syntax$Infix$Infix = F4(
	function (direction, precedence, operator, _function) {
		return {d6: direction, ed: _function, ey: operator, eB: precedence};
	});
				...
				return A2(
					...
					$stil4m$elm_syntax$Elm$Syntax$Range$combine(
						_List_fromArray(
							[
								current,
								$stil4m$elm_syntax$Elm$Syntax$Node$range(inf.ed)
							])),
...
var $stil4m$elm_syntax$Elm$Syntax$Type$Type = F4(
	function (documentation, name, generics, constructors) {
		return {d3: constructors, cm: documentation, dc: generics, a$: name};
	});
var $stil4m$elm_syntax$Elm$Syntax$TypeAlias$TypeAlias = F4(
	function (documentation, name, generics, typeAnnotation) {
		return {cm: documentation, dc: generics, a$: name, dO: typeAnnotation};
	});
							...
							return A2(
								...
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
									_List_fromArray(
										[
											start,
											$stil4m$elm_syntax$Elm$Syntax$Node$range(typeAlias.dO)
										])),
								typeAlias);
						},
						A2(
...
var $stil4m$elm_syntax$Elm$Syntax$Import$Import = F3(
	function (moduleName, moduleAlias, exposingList) {
		return {cp: exposingList, ek: moduleAlias, b5: moduleName};
	});
						...
						return $stil4m$elm_syntax$Combine$succeed(
							{
								...
								bo: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(start)
							});
					}),
				p);
		});
	...
	function (start, imp) {
		var allRanges = _List_fromArray(
			[
				...
				$elm$core$Maybe$Just(
				$stil4m$elm_syntax$Elm$Syntax$Node$range(imp.b5)),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.cp),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.ek)
			]);
		return A2(
			$stil4m$elm_syntax$Elm$Syntax$Node$Node,
			$stil4m$elm_syntax$Elm$Syntax$Range$combine(
	...
	var createEffectModule = F3(
		function (name, whereClauses, exp) {
			return $stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
				{d1: whereClauses.d1, cp: exp, b5: name, eM: whereClauses.eM});
		});
	return A2(
		$stil4m$elm_syntax$Combine$andMap,
		$stil4m$elm_syntax$Elm$Parser$Node$parser($stil4m$elm_syntax$Elm$Parser$Expose$exposeDefinition),
...
var $stil4m$elm_syntax$Elm$Syntax$Module$DefaultModuleData = F2(
	function (moduleName, exposingList) {
		return {cp: exposingList, b5: moduleName};
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {c_: col, dt: problem, aJ: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aJ, p.c_, p.dt);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{c_: 1, f: _List_Nil, i: 1, b: 0, aJ: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (range, comments, previousComments) {
		...
		while (true) {
			if (!comments.b) {
				...
				var restOfComments = comments.b;
				var _v1 = A2($elm$core$Basics$compare, commentRange.a6.aJ + 1, range.bo.aJ);
				switch (_v1) {
					case 1:
			...
			return {
				c0: A2(
					...
					A2(
						...
						howToUpdate(doc)),
					file.c0),
				K: A2($elm$core$List$cons, previous, file.K),
				R: remaining
			};
		} else {
			return {
				c0: A2($elm$core$List$cons, declaration, file.c0),
				K: A2($elm$core$List$cons, previous, file.K),
				R: remaining
			};
		}
				...
				function (x) {
					return _Utils_Tuple2(
						...
						A2(
							...
							{
								d6: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
								ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'todo'),
								ey: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, x),
								eB: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
							},
				...
				A2(
					...
					function (_v0) {
						...
						return A4(
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.ey),
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.d6),
							A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
				...
				switch (expression.$) {
					...
					case 15:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
							{
								c0: A2($stil4m$elm_syntax$Elm$Processing$visitLetDeclarations, table, letBlock.c0),
								bV: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, letBlock.bV)
							});
					case 16:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$CaseExpression(
							{
								d_: A2(
									...
									$elm$core$Tuple$mapSecond(
										$stil4m$elm_syntax$Elm$Processing$visitExpression(table)),
									caseBlock.d_),
								bV: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, caseBlock.bV)
							});
					case 17:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
							_Utils_update(
								lambda,
								{
									bV: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, lambda.bV)
								}));
					case 18:
...
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDecl = F2(
	function (table, _function) {
		...
		return _Utils_update(
			_function,
			{d5: newFunctionDeclaration});
	});
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDeclaration = F2(
	function (table, functionDeclaration) {
		var newExpression = A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, functionDeclaration.bV);
		return _Utils_update(
			functionDeclaration,
			{bV: newExpression});
	});
...
var $stil4m$elm_syntax$Elm$Processing$attachDocumentationAndFixOperators = F3(
	function (table, declaration, context) {
		...
		switch (_v0.$) {
			...
			case 3:
				return {
					c0: A2($elm$core$List$cons, declaration, context.c0),
					K: context.K,
					R: context.R
				};
			case 4:
...
var $stil4m$elm_syntax$Elm$Processing$buildSingle = F2(
	function (moduleIndex, imp) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, imp.cp);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			if (!_v0.a.$) {
				var _v1 = A2(
					$elm$core$Dict$get,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(imp.b5),
					moduleIndex);
				if (!_v1.$) {
					var module_ = _v1.a;
					...
					return A2(
						...
						function (elem) {
							return A2(
								...
								$stil4m$elm_syntax$Elm$Syntax$Node$value(elem.ey),
								importedOperators);
						},
	...
	function (rawFile, _v0) {
		...
		return $elm$core$Dict$fromList(
			A2(
				...
				function (x) {
					return _Utils_Tuple2(
						$stil4m$elm_syntax$Elm$Syntax$Node$value(x.ey),
						x);
				},
				A2(
					$elm$core$List$concatMap,
...
var $stil4m$elm_syntax$Elm$Processing$process = F2(
	function (processContext, rawFile) {
		...
		var changes = A3(
			...
			{c0: _List_Nil, K: _List_Nil, R: file.d2},
			file.c0);
		return {
			d2: $elm$core$List$concat(
				$elm$core$List$reverse(
					A2($elm$core$List$cons, changes.R, changes.K))),
			c0: $elm$core$List$reverse(changes.c0),
			ef: file.ef,
			el: file.el
		};
	});
var $jfmengels$elm_review$Review$FileParser$parse = function (source) {
	return A2(
		$elm$core$Result$map,
		$stil4m$elm_syntax$Elm$Processing$process($jfmengels$elm_review$Review$FileParser$elmProcessContext),
		A2(
	...
	function (path, _v0) {
		...
		return A2(
			...
			_Utils_update(
				project,
				{
					am: A2($elm$core$Dict$remove, path, project.am)
				}));
	});
...
var $jfmengels$elm_review$Review$Project$addReadme = F2(
	function (readme_, _v0) {
		...
		return _Utils_update(
			project,
			{
				cI: $elm$core$Maybe$Just(readme_)
			});
	});
...
var $elm$project_metadata_utils$Elm$Project$ApplicationInfo = F6(
	function (elm, dirs, depsDirect, depsIndirect, testDepsDirect, testDepsIndirect) {
		return {c3: depsDirect, c4: depsIndirect, c5: dirs, bQ: elm, dL: testDepsDirect, dM: testDepsIndirect};
	});
...
var $elm$project_metadata_utils$Elm$Project$PackageInfo = F8(
	function (name, summary, license, version, exposed, deps, testDeps, elm) {
		return {c2: deps, bQ: elm, c7: exposed, dn: license, a$: name, dG: summary, dK: testDeps, dR: version};
	});
	...
	if (!project.$) {
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(application.c3),
						$author$project$Elm$Review$Main$getPackageName(application.c4),
						$author$project$Elm$Review$Main$getPackageName(application.dL),
						$author$project$Elm$Review$Main$getPackageName(application.dM)
					])));
	} else {
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(packageInfo.c2),
						$author$project$Elm$Review$Main$getPackageName(packageInfo.dK)
					])));
	}
};
	...
	function (file, project) {
		if (_Utils_eq(
			...
			return A2(
				...
				{a5: file.eI, eA: file.eA},
				project);
		} else {
			var _v0 = $jfmengels$elm_review$Review$Project$elmJson(project);
			if (!_v0.$) {
				var oldElmJson = _v0.a;
				if (_Utils_eq(file.eA, oldElmJson.eA)) {
					var _v1 = A2($elm$json$Json$Decode$decodeString, $elm$project_metadata_utils$Elm$Project$decoder, file.eI);
					if (!_v1.$) {
						...
						return A3(
							...
							A2(
								...
								{eA: file.eA, c: newElmJson, bk: file.eI},
								project),
...
var $author$project$Elm$Review$Vendor$Serialize$build = F2(
	function (jsonEncoder, jsonDecoder) {
		return {Z: jsonDecoder, aW: jsonEncoder};
	});
		...
		var jsonEnc = function (v) {
			return _Utils_Tuple2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$elm$json$Json$Encode$int(am.bC),
						v)));
		};
		var jsonDecoder_ = F2(
			function (tag, orElse) {
				return _Utils_eq(tag, am.bC) ? jsonDecoderPiece : A2(am.Z, tag, orElse);
			});
		return {
			bC: am.bC + 1,
			Z: jsonDecoder_,
...
var $author$project$Elm$Review$Vendor$Serialize$record = function (ctor) {
	return {
		bX: 0,
		Z: $elm$json$Json$Decode$succeed(
			$elm$core$Result$Ok(ctor)),
		aW: function (_v0) {
			return _List_Nil;
		}
					...
					$author$project$Elm$Review$Vendor$Serialize$record(
						F4(
							function (startRow, startColumn, endRow, endColumn) {
								return {
									a6: {ay: endColumn, aJ: endRow},
									bo: {ay: startColumn, aJ: startRow}
								};
							})))))));
...
var $stil4m$elm_syntax$Elm$Syntax$Module$EffectModuleData = F4(
	function (moduleName, exposingList, command, subscription) {
		return {d1: command, cp: exposingList, b5: moduleName, eM: subscription};
	});
...
var $author$project$Elm$Review$Main$cacheFileRequest = F2(
	function (project, source) {
		var _v0 = A2(
			...
			function (module_) {
				return _Utils_eq(module_.eI, source);
			},
			$jfmengels$elm_review$Review$Project$modules(project));
		if (!_v0.$) {
			var ast = _v0.a.dW;
...
var $author$project$Elm$Review$File$decode = A4(
	...
	F3(
		function (path, source, ast) {
			return {dW: ast, eA: path, eI: source};
		}),
...
var $elm$project_metadata_utils$Elm$Type$var = function (isFirst) {
	return $elm$parser$Parser$variable(
		{dh: $elm$project_metadata_utils$Elm$Type$isInnerVarChar, dw: $elm$core$Set$empty, bo: isFirst});
};
	...
	return A2(
		...
		A2(
			...
			A5(
				...
				i.dD,
				i.dk,
				$elm$parser$Parser$Advanced$token(i.dB),
				i.dN)));
};
	...
	return $elm$parser$Parser$Advanced$sequence(
		{
			...
			dk: i.dk,
			dB: $elm$parser$Parser$toToken(i.dB),
			dD: i.dD,
			bo: $elm$parser$Parser$toToken(i.bo),
			dN: $elm$parser$Parser$toAdvancedTrailing(i.dN)
		});
};
...
function $elm$project_metadata_utils$Elm$Type$cyclic$tuple() {
	return A2(
		...
		$elm$parser$Parser$sequence(
			{
				a6: ')',
				dk: $elm$project_metadata_utils$Elm$Type$cyclic$tipe(),
				dB: ',',
				dD: $elm$project_metadata_utils$Elm$Type$spaces,
				bo: '(',
				dN: 0
			}));
}
...
var $elm$project_metadata_utils$Elm$Docs$Binop = F5(
	function (name, comment, tipe, associativity, precedence) {
		return {dV: associativity, a4: comment, a$: name, eB: precedence, cR: tipe};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Union = F4(
	function (name, comment, args, tags) {
		return {dU: args, a4: comment, a$: name, eQ: tags};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Value = F3(
	function (name, comment, tipe) {
		return {a4: comment, a$: name, cR: tipe};
	});
...
var $author$project$Elm$Review$Main$elmJsonDecoder = A4(
	...
	F3(
		function (path, raw, project) {
			return {eA: path, c: project, bk: raw};
		}),
	A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'path',
				$author$project$Elm$Review$Main$encodeFilePath(changedFile.eA)),
				_Utils_Tuple2(
				'source',
				$elm$json$Json$Encode$string(source))
			]));
...
var $jfmengels$elm_review$Review$Fix$applyReplace = F3(
	function (range, replacement, lines) {
		var startLine = A2(
			...
			range.bo.ay - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.bo.aJ - 1));
		var linesBefore = A2($elm$core$List$take, range.bo.aJ - 1, lines);
		var linesAfter = A2($elm$core$List$drop, range.a6.aJ, lines);
		var endLine = A2(
			$jfmengels$elm_review$Unicode$dropLeft,
			range.a6.ay - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.a6.aJ - 1));
		return $elm$core$List$concat(
			_List_fromArray(
				[
					linesBefore,
...
var $jfmengels$elm_review$Review$Fix$comparePosition = F2(
	function (a, b) {
		...
		if (_v0 === 1) {
			return A2($elm$core$Basics$compare, a.ay, b.ay);
		} else {
			var order = _v0;
			return order;
		}
...
var $jfmengels$elm_review$Review$Fix$collide = F2(
	function (a, b) {
		var _v0 = A2($jfmengels$elm_review$Review$Fix$comparePosition, a.a6, b.bo);
		switch (_v0) {
			case 0:
				return false;
			case 1:
				return false;
			default:
				var _v1 = A2($jfmengels$elm_review$Review$Fix$comparePosition, b.a6, a.bo);
				switch (_v1) {
					case 0:
						return false;
					case 1:
...
var $jfmengels$elm_review$Review$Fix$getFixRange = function (fix_) {
	switch (fix_.$) {
		...
		default:
			var position = fix_.a;
			return {a6: position, bo: position};
	}
};
...
var $jfmengels$elm_review$Review$Fix$toRecord = function (fix_) {
	switch (fix_.$) {
		case 1:
			var range = fix_.a;
			var replacement = fix_.b;
			return {cH: range, eG: replacement};
		case 0:
			var range = fix_.a;
			return {cH: range, eG: ''};
		default:
...
var $author$project$Elm$Review$Main$fixableFilesInProject = function (project) {
	var readme = A2(
		$elm$core$Maybe$withDefault,
		{eA: '$$Not a valid module name$$', eI: ''},
		A2(
			$elm$core$Maybe$map,
			function (r) {
				return {eA: r.eA, eI: r.a5};
			},
			$jfmengels$elm_review$Review$Project$readme(project)));
	var moduleFiles = A2(
		$elm$core$List$map,
	...
	var elmJson = A2(
		...
		A2(
			$elm$core$Maybe$map,
			function (r) {
				return {eA: r.eA, eI: r.bk};
			},
			$jfmengels$elm_review$Review$Project$elmJson(project)));
	return $elm$core$Dict$fromList(
		A2(
			$elm$core$List$cons,
			_Utils_Tuple2(elmJson.eA, elmJson),
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(readme.eA, readme),
				moduleFiles)));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Elm$Review$Reporter$diff, file.eI, fixedSource)
							])),
						_List_fromArray(
						[
							$author$project$Elm$Review$Text$from('\n')
...
var $author$project$Elm$Review$Main$fromReviewError = F3(
	function (suppressedErrors, links, error) {
		return {
			bO: $jfmengels$elm_review$Review$Rule$errorDetails(error),
			da: A2(
				$elm$core$Maybe$map,
				$author$project$Elm$Review$Reporter$hashFixes,
				$jfmengels$elm_review$Review$Rule$errorFixes(error)),
			aw: $jfmengels$elm_review$Review$Rule$errorMessage(error),
			cH: $jfmengels$elm_review$Review$Rule$errorRange(error),
			dx: A2($author$project$Elm$Review$Main$linkToRule, links, error),
			cK: $jfmengels$elm_review$Review$Rule$errorRuleName(error),
			dH: A2($author$project$Elm$Review$SuppressedErrors$member, error, suppressedErrors)
		};
	});
...
var $author$project$Elm$Review$Main$encodeError = F5(
	function (_v0, links, detailsMode, source, error) {
		var suppressedErrors = _v0.E;
		var reviewErrorsAfterSuppression = _v0.S;
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'path',
					$author$project$Elm$Review$Main$encodeFilePath(file.eA)),
					_Utils_Tuple2(
					'errors',
					A2(
						$elm$json$Json$Encode$list,
						A4($author$project$Elm$Review$Main$encodeError, suppressedErrorsData, links, detailsMode, file.eI),
						file.aC))
				]));
	});
...
var $author$project$Elm$Review$Main$groupErrorsByFile = F2(
	function (project, errors) {
		var files = $elm$core$List$concat(
			_List_fromArray(
				[
					...
					$elm$core$List$map,
					function (file) {
						return {eA: file.eA, eI: file.eI};
					},
					$jfmengels$elm_review$Review$Project$modules(project)),
					_List_fromArray(
					[
						{eA: 'GLOBAL ERROR', eI: ''},
						{eA: 'CONFIGURATION ERROR', eI: ''}
					]),
					function () {
					var _v0 = $jfmengels$elm_review$Review$Project$elmJson(project);
					if (!_v0.$) {
		...
		return A2(
			$elm$core$List$filter,
			function (file) {
				return !$elm$core$List$isEmpty(file.aC);
			},
			A2(
				$elm$core$List$map,
				function (file) {
					return {
						aC: A2(
							...
							errors),
						eA: (file.eA === 'GLOBAL ERROR') ? $author$project$Elm$Review$Reporter$Global : ((file.eA === 'CONFIGURATION ERROR') ? $author$project$Elm$Review$Reporter$ConfigurationError : $author$project$Elm$Review$Reporter$FilePath(file.eA)),
						eI: file.eI
					};
				},
				files));
...
var $author$project$Elm$Review$Main$makeReport = F2(
	function (failedFixesDict, model) {
		var _v0 = function () {
			if ($elm$core$List$isEmpty(model.S) && model.bp) {
				var suppressedErrors = $author$project$Elm$Review$SuppressedErrors$fromReviewErrors(model.a2);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{E: suppressedErrors}),
					A2(
						...
						A2($elm$core$List$map, $jfmengels$elm_review$Review$Rule$ruleName, model.bm),
						suppressedErrors));
			} else {
				return _Utils_Tuple2(model, $elm$json$Json$Encode$null);
			}
		}();
		var newModel = _v0.a;
					...
					_List_fromArray(
						[
							...
							function () {
								var _v1 = newModel.a1;
								if (!_v1) {
									var errorsByFile = A2($author$project$Elm$Review$Main$groupErrorsByFile, model.c, model.S);
									var filesWithError = A2(
										...
										function (file) {
											return {
												aC: A2(
													$elm$core$List$map,
													A2($author$project$Elm$Review$Main$fromReviewError, newModel.E, newModel.aY),
													file.aC),
												eA: file.eA,
												eI: file.eI
											};
									...
									return $author$project$Elm$Review$Main$encodeReport(
										A2(
											$author$project$Elm$Review$Reporter$formatReport,
											{O: newModel.O, a7: newModel.a7, c9: failedFixesDict, bi: newModel.bi, E: newModel.E, ab: newModel.ab},
											filesWithError));
								} else {
									var errorsByFile = A2($author$project$Elm$Review$Main$groupErrorsByFile, model.c, model.a2);
									return A2(
										$elm$json$Json$Encode$list,
										A3(
											$author$project$Elm$Review$Main$encodeErrorByFile,
											{S: model.S, E: newModel.E},
											newModel.aY,
											newModel.O),
										errorsByFile);
								}
...
var $author$project$Elm$Review$Main$fixOneByOne = function (model) {
	...
	if (!_v0.$) {
		var file = _v0.a.cr;
		var error = _v0.a.cn;
		var fixedSource = _v0.a.aD;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					aB: $author$project$Elm$Review$Main$AwaitingError(error)
				}),
						...
						[
							...
							$author$project$Elm$Review$Main$encodeReport(
								A5(
									...
									model.O,
									{
										eA: $author$project$Elm$Review$Reporter$FilePath(file.eA),
										eI: file.eI
									},
									A3($author$project$Elm$Review$Main$fromReviewError, model.E, model.aY, error),
									fixedSource))),
							_Utils_Tuple2(
							'changedFiles',
							A2(
...
var $jfmengels$elm_review$Review$Project$precomputeModuleGraph = function (project) {
	...
	if (!_v0.$) {
		...
		var moduleGraph = $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(p.am));
		return _Utils_update(
			p,
			{
				b3: $elm$core$Maybe$Just(moduleGraph)
			});
	}
};
...
var $author$project$Elm$Review$Main$refuseError = F2(
	function (error, model) {
		return _Utils_update(
			model,
			{
				bl: A2($author$project$Elm$Review$RefusedErrorFixes$insert, error, model.bl)
			});
	});
	...
	function (path, error, remainingErrors, model) {
		var errorsForFile = A2(
			...
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, path, model.at)));
		return _Utils_update(
			model,
			{
				at: A3($elm$core$Dict$insert, path, errorsForFile, model.at),
				av: A2($author$project$Elm$Review$Progress$fixWasApplied, remainingErrors, model.av)
			});
	});
						...
						if (!_v2.b.$) {
							...
							return A2(
								...
								_List_fromArray(
									[
										_Utils_eq(
										$elm$core$Set$fromList(oldApp.c5),
										$elm$core$Set$fromList(newApp.c5)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(0),
										_Utils_eq(
	...
	function (visitedModules, projectModules) {
		...
		while (true) {
			if (!projectModules.b) {
				...
				if (_v1.$ === 1) {
					var $temp$visitedModules = A3($elm$core$Dict$insert, moduleName, projectModule.eA, visitedModules),
...
var $jfmengels$elm_review$Review$Rule$elmReviewGlobalError = function (_v0) {
	...
	var details = _v0.bO;
	return $jfmengels$elm_review$Review$Rule$SpecifiedError(
		{bO: details, cs: 'GLOBAL ERROR', cu: $elm$core$Maybe$Nothing, aw: message, cH: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, cK: '', dJ: 3});
};
...
var $jfmengels$elm_review$Review$Rule$duplicateModulesGlobalError = function (duplicate) {
	var paths = $elm$core$String$concat(
		A2(
			...
			$elm$core$List$sort(duplicate.ds)));
	return $jfmengels$elm_review$Review$Rule$errorToReviewError(
		$jfmengels$elm_review$Review$Rule$elmReviewGlobalError(
			{
				bO: _List_fromArray(
					[
						'I found several modules with the name `' + (A2($elm$core$String$join, '.', duplicate.b5) + '`. Depending on how I choose to resolve this, I might give you different reports. Since this is a compiler error anyway, I require this problem to be solved. Please fix this then try running `elm-review` again.'),
				...
				aw: 'Found several modules named `' + (A2($elm$core$String$join, '.', duplicate.b5) + '`')
			}));
};
...
var $jfmengels$elm_review$Review$Rule$parsingError = function (rawFile) {
	return {
		...
		cs: rawFile.eA,
		cu: $elm$core$Maybe$Nothing,
		aw: rawFile.eA + ' is not a correct Elm module',
		cH: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
		cK: 'ParsingError',
		dJ: 0
	};
...
var $jfmengels$elm_review$Vendor$IntDict$determineBranchRelation = F2(
	function (l, r) {
		...
		var mask = $jfmengels$elm_review$Vendor$IntDict$highestBitSet(
			A2($jfmengels$elm_review$Vendor$IntDict$mostSignificantBranchingBit, lp.a3, rp.a3));
		...
		var childEdge = F2(
			function (branchPrefix, c) {
				return A2($jfmengels$elm_review$Vendor$IntDict$isBranchingBitSet, branchPrefix, c.g.an) ? 1 : 0;
			});
	...
	function (l, r) {
		...
		while (true) {
			...
			while (true) {
					...
					switch (_v0.a.$) {
						...
						default:
							switch (_v0.b.$) {
								...
								case 1:
									var lr = _v0.b.a;
									var _v3 = A2($jfmengels$elm_review$Vendor$IntDict$get, lr.bE, l);
									if (!_v3.$) {
										var v = _v3.a;
										return A2($jfmengels$elm_review$Vendor$IntDict$leaf, lr.bE, v);
									} else {
										return $jfmengels$elm_review$Vendor$IntDict$Empty;
									}
								default:
				...
				var ll = _v0.a.a;
				return A2($jfmengels$elm_review$Vendor$IntDict$member, ll.bE, r) ? l : $jfmengels$elm_review$Vendor$IntDict$Empty;
			}
			var _v2 = _v0.b;
			return $jfmengels$elm_review$Vendor$IntDict$Empty;
		}
		...
		var updateIncomingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						dg: A3($jfmengels$elm_review$Vendor$IntDict$update, nodeId, upd, node.dg)
					});
			});
		var flippedFoldl = F3(
			function (f, dict, acc) {
...
var $jfmengels$elm_review$Vendor$Graph$emptyDiff = {dg: $jfmengels$elm_review$Vendor$IntDict$empty, h: $jfmengels$elm_review$Vendor$IntDict$empty};
	...
	function (old, _new) {
		...
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				...
				var ins = _v0.b.a;
				return {
					dg: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.h, $jfmengels$elm_review$Vendor$IntDict$empty),
					h: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.dg, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			}
		} else {
			if (_v0.b.$ === 1) {
				...
				var _v3 = _v0.b;
				return {
					dg: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.h, $jfmengels$elm_review$Vendor$IntDict$empty),
					h: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.dg, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			} else {
				var rem = _v0.a.a;
				var ins = _v0.b.a;
				return _Utils_eq(rem, ins) ? $jfmengels$elm_review$Vendor$Graph$emptyDiff : {
					...
					h: A3(
						...
						$jfmengels$elm_review$Vendor$Graph$Insert,
						ins.dg,
						A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.dg, $jfmengels$elm_review$Vendor$IntDict$empty))
				};
			}
		}
	});
		...
		var wrappedUpdater = function (rep) {
			...
			var filterInvalidEdges = function (ctx) {
				return $jfmengels$elm_review$Vendor$IntDict$filter(
					F2(
						function (id, _v0) {
							return _Utils_eq(id, ctx.dp.bY) || A2($jfmengels$elm_review$Vendor$IntDict$member, id, rep);
						}));
			};
			var cleanUpEdges = function (ctx) {
				return _Utils_update(
					ctx,
					{
						dg: A2(filterInvalidEdges, ctx, ctx.dg),
...
var $jfmengels$elm_review$Vendor$Graph$alongIncomingEdges = function (ctx) {
	return $jfmengels$elm_review$Vendor$IntDict$keys(ctx.dg);
};
...
var $jfmengels$elm_review$Review$Rule$reachedTarget = F2(
	function (targetNode, path) {
		...
		if (!_v0.$) {
			var node = _v0.a;
			return _Utils_eq(node.dp.bY, targetNode);
		} else {
			return false;
		}
	});
	...
	function (targetNode, path, distance, acc) {
		if ($elm$core$List$isEmpty(acc)) {
			if (!distance) {
				...
				if (!_v0.$) {
					var head = _v0.a;
					return A2($jfmengels$elm_review$Vendor$IntDict$member, head.dp.bY, head.dg) ? _List_fromArray(
						[head.dp]) : acc;
				} else {
					return acc;
				}
		...
		while (true) {
			if (!nodesToVisit.b) {
				...
				var cycle = A5(
					...
					$jfmengels$elm_review$Review$Rule$visitorDiscoverCycle(startingNode.bY),
					_List_fromArray(
						[startingNode.bY]),
					_List_Nil,
					graph).a;
...
var $jfmengels$elm_review$Review$Rule$findCycle = F2(
	function (graph, edge) {
		var initialCycle = A5(
			$jfmengels$elm_review$Vendor$Graph$guidedBfs,
			$jfmengels$elm_review$Vendor$Graph$alongIncomingEdges,
			$jfmengels$elm_review$Review$Rule$visitorDiscoverCycle(edge.eR),
			_List_fromArray(
				[edge.ec]),
			_List_Nil,
			graph).a;
				...
				$jfmengels$elm_review$Review$Rule$elmReviewGlobalError(
					{
						...
						aw: 'Your module imports form a cycle'
					})));
	});
...
var $jfmengels$elm_review$Review$Rule$needsToComputeScope = function (rules) {
	return A2(
		$elm$core$List$any,
		function (_v0) {
			var requestedData = _v0.H;
			var _v1 = requestedData;
			var requestedData_ = _v1;
			return requestedData_.al;
		},
		rules);
};
var $jfmengels$elm_review$Review$Rule$runRules = F3(
	function (rules, project, nodeContexts) {
		return A3(
			...
			F2(
				function (_v0, _v1) {
					var exceptions = _v0.ah;
					var ruleImplementation = _v0.ao;
					var errors = _v1.a;
...
var $jfmengels$elm_review$Review$Rule$scope_dependenciesVisitor = F2(
	function (dependencies, innerContext) {
		var dependenciesModules = $elm$core$Dict$fromList(
			A2(
				$elm$core$List$map,
				function (dependencyModule) {
					return _Utils_Tuple2(dependencyModule.a$, dependencyModule);
				},
				A2(
					$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
		...
		return _Utils_update(
			innerContext,
			{M: dependenciesModules});
	});
var $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts = F2(
	function (newContext, previousContext) {
		return {
			M: previousContext.M,
			a_: A2($elm$core$Dict$union, newContext.a_, previousContext.a_),
			am: A2($elm$core$Dict$union, previousContext.am, newContext.am)
		};
	});
...
var $jfmengels$elm_review$Review$Rule$createFakeImport = function (_v0) {
	var moduleName = _v0.b5;
	var moduleAlias = _v0.ek;
	var exposingList = _v0.cp;
	return {
		cp: A2(
			$elm$core$Maybe$map,
		...
		ek: A2(
			...
			A2(
				...
				$stil4m$elm_syntax$Elm$Syntax$Node$Node($stil4m$elm_syntax$Elm$Syntax$Range$emptyRange)),
			moduleAlias),
		b5: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, moduleName)
	};
};
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cp: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a$: 'List', ex: $elm$core$Maybe$Nothing}),
							$stil4m$elm_syntax$Elm$Syntax$Exposing$InfixExpose('::')
						])),
				ek: $elm$core$Maybe$Nothing,
				b5: _List_fromArray(
				...
				cp: explicit(
					_List_fromArray(
						[
							...
							{
								a$: 'Maybe',
								ex: $elm$core$Maybe$Just($stil4m$elm_syntax$Elm$Syntax$Range$emptyRange)
							})
						])),
				ek: $elm$core$Maybe$Nothing,
				b5: _List_fromArray(
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cp: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a$: 'String', ex: $elm$core$Maybe$Nothing})
						])),
				ek: $elm$core$Maybe$Nothing,
				b5: _List_fromArray(
					['String'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cp: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a$: 'Char', ex: $elm$core$Maybe$Nothing})
						])),
				ek: $elm$core$Maybe$Nothing,
				b5: _List_fromArray(
					['Char'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cp: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a$: 'Program', ex: $elm$core$Maybe$Nothing})
						])),
				ek: $elm$core$Maybe$Nothing,
				b5: _List_fromArray(
					['Platform'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cp: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a$: 'Cmd', ex: $elm$core$Maybe$Nothing})
						])),
				ek: $elm$core$Maybe$Just('Cmd'),
				b5: _List_fromArray(
					['Platform', 'Cmd'])
			}),
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cp: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a$: 'Sub', ex: $elm$core$Maybe$Nothing})
						])),
				ek: $elm$core$Maybe$Just('Sub'),
				b5: _List_fromArray(
					['Platform', 'Sub'])
			})
		]);
...
var $jfmengels$elm_review$Review$Rule$registerImportAlias = F2(
	function (import_, innerContext) {
		var _v0 = import_.ek;
		if (_v0.$ === 1) {
			var moduleName = $stil4m$elm_syntax$Elm$Syntax$Node$value(import_.b5);
					...
					aE: A3(
						...
						function (previousValue) {
							return $elm$core$Maybe$Just(
								A2(
									$elm$core$List$cons,
									$stil4m$elm_syntax$Elm$Syntax$Node$value(import_.b5),
									A2($elm$core$Maybe$withDefault, _List_Nil, previousValue)));
						},
						innerContext.aE)
				});
		...
		switch (_v0.$) {
			...
			case 2:
				...
				return A2(
					$elm$core$List$any,
					function (alias) {
						return _Utils_eq(alias.a$, name);
					},
					module_.cT) ? _List_fromArray(
					[name]) : _List_Nil;
			default:
				var name = _v0.a.a$;
				var open = _v0.a.ex;
...
var $jfmengels$elm_review$Review$Rule$registerImportExposed = F2(
	function (import_, innerContext) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, import_.cp);
		if (_v0.$ === 1) {
			return innerContext;
		} else {
			var exposing_ = _v0.a;
			...
			var module_ = A2(
				$elm$core$Maybe$withDefault,
				{
					...
					cX: _List_Nil,
					a4: '',
					a$: $jfmengels$elm_review$Review$Rule$joinModuleName(moduleName),
					dP: _List_Nil,
					dQ: _List_Nil
				},
				function () {
					var _v4 = A2($elm$core$Dict$get, moduleName, innerContext.am);
					if (!_v4.$) {
						var m = _v4.a;
					...
					$elm$core$List$concat(
						_List_fromArray(
							[
								...
								module_.dP),
								A2($elm$core$List$map, nameWithModuleName, module_.dQ),
								A2($elm$core$List$map, nameWithModuleName, module_.cT),
								A2($elm$core$List$map, nameWithModuleName, module_.cX)
							])));
				var exposedTypes = $elm$core$Dict$fromList(
					A2(
						$elm$core$List$append,
						A2($elm$core$List$map, nameWithModuleName, module_.dP),
						A2($elm$core$List$map, nameWithModuleName, module_.cT)));
				return _Utils_update(
					innerContext,
					{
						aS: A2($elm$core$Dict$union, exposedValues, innerContext.aS),
						aT: A2($elm$core$Dict$union, innerContext.aT, exposedTypes)
					});
			} else {
...
var $jfmengels$elm_review$Review$Rule$scope_fromProjectToModule = F3(
	function (_v0, moduleName, projectContext) {
		return $jfmengels$elm_review$Review$Rule$registerPrelude(
			{
				...
				j: $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty(
					$stil4m$elm_syntax$Elm$Syntax$Node$value(moduleName)),
				am: projectContext.am,
				l: $jfmengels$elm_review$Review$Rule$nonemptyList_fromElement($jfmengels$elm_review$Review$Rule$emptyScope)
			});
	});
var $jfmengels$elm_review$Review$Rule$scope_initialProjectContext = {M: $elm$core$Dict$empty, a_: $elm$core$Dict$empty, am: $elm$core$Dict$empty};
	...
	function (context, valueName, moduleName) {
		if (!moduleName.b) {
			return A2($jfmengels$elm_review$Review$Rule$isInScope, valueName, context.l) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, valueName, context.aS));
		} else {
			if (!moduleName.b.b) {
					...
					if (_v1.a.b && (!_v1.a.b.b)) {
						...
						var _v3 = A2(
							...
							function (aliasedModuleName) {
								var _v4 = A2($elm$core$Dict$get, aliasedModuleName, context.am);
								if (!_v4.$) {
									var module_ = _v4.a;
...
var $jfmengels$elm_review$Review$Rule$moduleNameForType = F3(
	function (context, typeName, moduleName) {
		if (!moduleName.b) {
			return A2($elm$core$Set$member, typeName, context.aZ) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, typeName, context.aT));
		} else {
			if (!moduleName.b.b) {
				var _v1 = A2(
					$elm$core$Dict$get,
		...
		switch (_v0.$) {
			case 0:
				...
				var newScope = _Utils_update(
					...
					{
						a0: $jfmengels$elm_review$Review$Rule$parameters(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d5).cU)
					});
				var newContext = A2(
			...
			case 3:
				var signature = _v0.a;
				var moduleNamesFromSignature = A2($jfmengels$elm_review$Review$Rule$collectModuleNamesFromTypeAnnotation, context, signature.dO);
		...
		return A2(
			...
			function (scope) {
				return _Utils_update(
					scope,
					{
						a0: A3($elm$core$Dict$insert, name, variableInfo, scope.a0)
					});
			},
			scopes);
	});
var $jfmengels$elm_review$Review$Rule$addToScope = F2(
	function (variableData, innerContext) {
		var newScopes = A3(
			...
			variableData,
			$stil4m$elm_syntax$Elm$Syntax$Node$value(variableData.dp),
			innerContext.l);
		return _Utils_update(
			innerContext,
			{l: newScopes});
			...
			innerContext,
			{
				bv: A2(
					$elm$core$List$cons,
					{
						...
						a4: '',
						a$: name,
						cR: $elm$project_metadata_utils$Elm$Type$Tuple(_List_Nil)
					},
					innerContext.bv)
			});
	});
			...
			innerContext,
			{
				bz: A2(
					$elm$core$List$cons,
					{
						...
						a$: name,
						cR: A2($jfmengels$elm_review$Review$Rule$convertTypeSignatureToDocsType, innerContext, _function.eH)
					},
					innerContext.bz)
			});
	});
var $jfmengels$elm_review$Review$Rule$registerIfExposed = F3(
	function (registerFn, name, innerContext) {
		return (innerContext.bT || A2($elm$core$Dict$member, name, innerContext.bS)) ? A2(registerFn, name, innerContext) : innerContext;
	});
var $jfmengels$elm_review$Review$Rule$scope_registerDeclaration = F2(
	function (declaration, innerContext) {
		...
		switch (_v0.$) {
			case 0:
				var _function = _v0.a;
				var nameNode = $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d5).a$;
				return A3(
			...
			case 1:
				...
				return A3(
					...
					$stil4m$elm_syntax$Elm$Syntax$Node$value(alias.a$),
					function (ctx) {
						var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(alias.dO);
						if (_v1.$ === 4) {
							return A2(
								$jfmengels$elm_review$Review$Rule$addToScope,
								{dp: alias.a$, aL: 0},
					...
					A3(
						...
						F2(
							function (constructor, innerContext_) {
								var constructorName = $stil4m$elm_syntax$Elm$Syntax$Node$value(constructor).a$;
								return A2(
									$jfmengels$elm_review$Review$Rule$addToScope,
									{dp: constructorName, aL: 1},
									innerContext_);
							}),
						_Utils_update(
							innerContext,
			...
			case 3:
				...
				return A3(
					...
					$stil4m$elm_syntax$Elm$Syntax$Node$value(signature.a$),
					A2(
						$jfmengels$elm_review$Review$Rule$addToScope,
						{dp: signature.a$, aL: 5},
						innerContext));
	...
	function (node, innerContext) {
		...
		if (!_v0.$) {
			...
			return _Utils_update(
				innerContext,
				{
					bS: $jfmengels$elm_review$Review$Rule$exposedElements(list)
				});
		}
	});
...
var $jfmengels$elm_review$Review$Rule$scope_popScopeExit = F2(
	function (node, context) {
		var currentScope = $jfmengels$elm_review$Review$Rule$nonemptyList_head(context.l);
		return _Utils_eq(node, currentScope.bN) ? _Utils_update(
			context,
			{
				l: $jfmengels$elm_review$Review$Rule$nonemptyList_pop(context.l)
			}) : context;
...
var $jfmengels$elm_review$Review$Rule$withDeclarationExitVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				X: A2($elm$core$List$cons, visitor, schema.X)
			});
	});
...
var $jfmengels$elm_review$Review$Rule$withDataExtractor = F2(
	function (dataExtractor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				az: $elm$core$Maybe$Just(dataExtractor)
			});
	});
				...
				$jfmengels$elm_review$Review$Rule$initContextCreator(
					F3(
						function (moduleKey, moduleNameNode_, projectContext) {
							return A3(functions.cw, moduleKey, moduleNameNode_, projectContext);
						}))));
		return _Utils_update(
			schema,
			{
				aP: $elm$core$Maybe$Just(
					{
						au: functions.au,
						aQ: $jfmengels$elm_review$Review$Rule$withModuleNameNode(
							$jfmengels$elm_review$Review$Rule$withModuleKey(
								$jfmengels$elm_review$Review$Rule$initContextCreator(
									F3(
										function (moduleKey, moduleNameNode_, moduleContext) {
											return A3(functions.aQ, moduleKey, moduleNameNode_, moduleContext);
										}))))
					}),
				I: $elm$core$Maybe$Just(moduleContextCreator)
			});
	});
var $jfmengels$elm_review$Review$Rule$scopeRule = $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor(
	A2(
		...
		function (projectContext) {
			return projectContext.a_;
		},
		A2(
			$jfmengels$elm_review$Review$Rule$withModuleContext,
			{au: $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts, aQ: $jfmengels$elm_review$Review$Rule$scope_fromModuleToProject, cw: $jfmengels$elm_review$Review$Rule$scope_fromProjectToModule},
			A2(
				$jfmengels$elm_review$Review$Rule$withModuleVisitor,
				$jfmengels$elm_review$Review$Rule$scope_moduleVisitor,
				A2(
					$jfmengels$elm_review$Review$Rule$withDirectDependenciesProjectVisitor,
					$jfmengels$elm_review$Review$Rule$scope_pairWithNoErrors($jfmengels$elm_review$Review$Rule$scope_dependenciesVisitor),
					$jfmengels$elm_review$Review$Rule$withContextFromImportedModules(
	...
	function (project, rules, maybeProjectData, nodeContexts) {
		...
		var scopeResult = function () {
			if ($jfmengels$elm_review$Review$Rule$needsToComputeScope(rules)) {
				...
				return {
					a8: extract,
					bK: $elm$core$Maybe$Just(cache)
				};
			} else {
				return {a8: $elm$core$Maybe$Nothing, bK: $elm$core$Maybe$Nothing};
			}
		}();
		...
		var projectWithLookupTables = _Utils_update(
			p,
			{em: moduleNameLookupTables});
		var _v0 = A3($jfmengels$elm_review$Review$Rule$runRules, rules, projectWithLookupTables, nodeContexts);
		var errors = _v0.a;
		var newRules = _v0.b;
		return {
			aC: A2($elm$core$List$map, $jfmengels$elm_review$Review$Rule$errorToReviewError, errors),
			bK: scopeResult.bK,
			bm: newRules
		};
	});
var $jfmengels$elm_review$Review$Rule$reviewV2 = F3(
	function (rules, maybeProjectData, project) {
		...
		if (!_v0.$) {
			...
			var errors = _v0.a;
			return {aC: errors, bK: maybeProjectData, bm: rules};
		}
	});
var $author$project$Elm$Review$Main$runReview = function (model) {
	var _v0 = A3($jfmengels$elm_review$Review$Rule$reviewV2, model.bm, model.bK, model.c);
	var errors = _v0.aC;
	var rules = _v0.bm;
	var projectData = _v0.bK;
	return _Utils_update(
		model,
		{
			aB: $author$project$Elm$Review$Main$NotAwaiting,
			bK: projectData,
			a2: errors,
			S: A3($author$project$Elm$Review$SuppressedErrors$apply, model.ab, model.E, errors),
			bm: rules
		});
};
	...
	function (failedFixesDict, model) {
		...
		while (true) {
			...
			if (!_v0.b.$) {
				...
				var file = _v0.b.a.cr;
				var error = _v0.b.a.cn;
				var fixedSource = _v0.b.a.aD;
				var remainingErrors = _v0.b.a.dv;
				var newProject = A2(
				...
				var _v1 = _v0.b;
				return $elm$core$Maybe$Just(
					{cq: newFailedFixesDict, cF: model});
			}
		}
	});
	...
	function (before, after) {
		...
		var afterReadme = function () {
			...
			if (!_v6.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(readme.eA, readme.a5)
					]);
			} else {
				return _List_Nil;
			}
		...
		var afterElmJson = function () {
			...
			if (!_v5.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(elmJson.eA, elmJson.bk)
					]);
			} else {
				return _List_Nil;
			}
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						$elm$core$List$map,
						function (mod) {
							return _Utils_Tuple2(mod.eA, mod.eI);
						},
		...
		return A6(
			...
			F4(
				function (_v2, beforeModule, fixedSource, acc) {
					return (!_Utils_eq(beforeModule.eI, fixedSource)) ? A2(
						$elm$core$List$cons,
						{aD: fixedSource, eA: beforeModule.eA, eI: beforeModule.eI},
						acc) : acc;
				}),
			F3(
		...
		_List_fromArray(
			[
				...
				[
					...
					$author$project$Elm$Review$Text$from(
						A3(
							...
							80,
							'-',
							' ' + $author$project$Elm$Review$Reporter$filePath(file.eA))))
				]),
				A2(
				$elm$core$List$cons,
				...
				A2(
					...
					$elm$core$List$reverse(file.aC))),
				A2($author$project$Elm$Review$Reporter$diff, file.eI, file.aD)
			]));
};
...
var $author$project$Elm$Review$Main$fixAll = function (model) {
	...
	if (!_v0.$) {
		var failedFixesDict = _v0.a.cq;
		var newModel = _v0.a.cF;
		...
		if (!_v1.b) {
			...
			var changedFiles = A2(
				...
				function (_v2) {
					var path = _v2.eA;
					var source = _v2.eI;
					var fixedSource = _v2.aD;
					return {
						aC: A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
							A2($elm$core$Dict$get, path, newModel.at)),
						aD: fixedSource,
						eA: (path === 'GLOBAL ERROR') ? $author$project$Elm$Review$Reporter$Global : $author$project$Elm$Review$Reporter$FilePath(path),
						eI: source
					};
				},
				diffs);
			...
			return _Utils_Tuple2(
				_Utils_update(
					newModel,
					{aB: $author$project$Elm$Review$Main$AwaitingFixAll, ct: newModel.c, c: model.c}),
				$author$project$Elm$Review$Main$askConfirmationToFix(
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
		...
		default:
			...
			return _Utils_Tuple2(
				_Utils_update(
					newModel,
					{
						av: $author$project$Elm$Review$Progress$reset(newModel.av)
					}),
				cmd);
	}
};
...
var $author$project$Elm$Review$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
								...
								$elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
											'path',
											$elm$json$Json$Encode$string(rawFile.eA)),
											_Utils_Tuple2(
											'cacheRequest',
											A2($author$project$Elm$Review$Main$cacheFileRequest, project, rawFile.eI))
										]))));
					} else {
						var ast = _v2.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									c: A2(
										...
										{dW: ast, eA: rawFile.eA, eI: rawFile.eI},
										model.c)
								}),
							$author$project$Elm$Review$Main$acknowledgeFileReceipt(
								$elm$json$Json$Encode$object(
				...
				if (_v6.$ === 1) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bi: $author$project$Elm$Review$SuppressedErrors$count(suppressedErrors),
								E: suppressedErrors
							}),
						$elm$core$Platform$Cmd$none);
				}
				...
				if (_v7.$ === 1) {
					...
					return _Utils_eq(suppressedErrors, model.E) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : A2(
						...
						_Utils_update(
							model,
							{
								S: A3($author$project$Elm$Review$SuppressedErrors$apply, model.ab, suppressedErrors, model.a2),
								E: suppressedErrors
							}));
				}
			case 7:
			...
			case 9:
				var newModel = $author$project$Elm$Review$Main$runReview(
					_Utils_update(
						model,
						{
							at: $elm$core$Dict$empty,
				...
				return _Utils_Tuple2(
					...
					$author$project$Elm$Review$Main$suppressionsResponse(
						A2(
							$author$project$Elm$Review$SuppressedErrors$encode,
							_List_Nil,
							$author$project$Elm$Review$SuppressedErrors$fromReviewErrors(newModel.a2))));
			case 10:
						...
						return (_Utils_cmp(
							...
							$author$project$Elm$Review$Main$reportOrFix(
								$author$project$Elm$Review$Main$runReview(
									_Utils_update(
										model,
										{a7: true, at: $elm$core$Dict$empty, c: newProject}))));
					} else {
						var _v10 = _v9.a;
						var _v11 = model.aB;
						switch (_v11.$) {
			...
			default:
				return _Utils_Tuple2(
					...
					$author$project$Elm$Review$Main$fixConfirmationStatus(
						!_Utils_eq(model.aB, $author$project$Elm$Review$Main$NotAwaiting)));
		}
	});
var $elm$core$Platform$worker = _Platform_worker;
var $author$project$Elm$Review$Main$main = $elm$core$Platform$worker(
	{
		eh: $author$project$Elm$Review$Main$init,
		eN: function (_v0) {
			return $author$project$Elm$Review$Main$subscriptions;
		},
		eT: $author$project$Elm$Review$Main$update
	});
